...
Write-Host "status: manifest_validator_exit_code=$ExitCode"
Write-Host "manifest_validation_json: outputs\orderbook_um_81_full_matching_aggtrades_manifest_validation.json"
Write-Host "manifest_validation_md: outputs\orderbook_um_81_full_matching_aggtrades_manifest_validation.md"
Write-Host "download_manifest_csv: outputs\orderbook_um_81_full_matching_aggtrades_download_manifest.csv"
Write-Host "download_manifest_jsonl: outputs\orderbook_um_81_full_matching_aggtrades_download_manifest.jsonl"
