...
& $Python 'src\edge_factory_orderbook_um_manifest_validator_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: manifest_validator_exit_code=$ExitCode"
Write-Host "validator_report: outputs\orderbook_um_manifest_validator_report.json"
Write-Host "coverage_summary: outputs\orderbook_um_bookdepth_coverage_summary.json"
