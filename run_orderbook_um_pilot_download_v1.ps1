...
& $Python 'src\edge_factory_orderbook_um_pilot_downloader_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: pilot_download_exit_code=$ExitCode"
Write-Host "pilot_schema_summary: outputs\orderbook_um_pilot_schema_summary.json"
