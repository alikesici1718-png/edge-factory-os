...
MODULE_PATH = "tools/edge_factory_os_repo_only_binance_okx_overlap_funding_crowding_reversal_full_range_evaluator_v1.py"
ARTIFACT_PATH = "artifacts/strategy_evaluations/binance_okx_overlap_funding_crowding_reversal_full_range_evaluator_v1.json"
STATUS = "PASS_REPO_ONLY_BINANCE_OKX_OVERLAP_FUNDING_CROWDING_REVERSAL_FULL_RANGE_EVALUATED"
ARTIFACT_KIND = "BINANCE_OKX_OVERLAP_FUNDING_CROWDING_REVERSAL_FULL_RANGE_EVALUATION"
...
def build_evaluation() -> Dict[str, Any]:
    ...
    review_hash = verify_hash(review)
    ...
    payload: Dict[str, Any] = {
        ...
        "evaluation_policy": {
            ...
            "holdout_policy": {
                ...
                "holdout_used_for_runtime_live_capital": False,
                "holdout_positive_does_not_override_validation_failure": True,
                "holdout_does_not_allow_candidate_or_edge": True,
                "final_edge_claim_requires_external_or_future_holdout": True,
                "holdout_policy_source": "derived_from_fixed_config_task_contract_and_execution_policy",
            },
        ...
        "holdout_findings": {
            "holdout_gross_metric_bps": holdout["gross_metric_bps"],
            "holdout_net_metric_bps": holdout["net_metric_bps"],
            "holdout_positive_after_cost": holdout["positive_after_cost"],
            "holdout_reported_separately": True,
            "holdout_used_for_config_selection": False,
            "holdout_used_for_candidate_generation": False,
            "holdout_used_for_edge_claim": False,
        ...
        "evaluator_findings": {
            ...
            "evaluator_reason": (
                ...
                f"holdout net metric is {holdout['net_metric_bps']} bps but holdout is diagnostic only and cannot override validation."
            ),
        },
        ...
        "source_artifacts": {
            ...
            "funding_review_payload_hash": review_hash,
        },
        "replacement_checks_all_true": True,
    }
...
def main() -> None:
    ...
    summary = {
        ...
        "holdout_net_metric_bps": artifact["holdout_findings"]["holdout_net_metric_bps"],
        "holdout_reported_separately": True,
        "candidate_generation": False,
        "edge_claim": False,
        "runtime_live_capital": False,
