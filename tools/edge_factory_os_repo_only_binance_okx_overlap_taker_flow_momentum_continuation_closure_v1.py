...
MODULE_PATH = "tools/edge_factory_os_repo_only_binance_okx_overlap_taker_flow_momentum_continuation_closure_v1.py"
ARTIFACT_PATH = "artifacts/strategy_closures/binance_okx_overlap_taker_flow_momentum_continuation_closure_v1.json"
STATUS = "PASS_REPO_ONLY_BINANCE_OKX_OVERLAP_TAKER_FLOW_MOMENTUM_CONTINUATION_CLOSURE_CREATED"
ARTIFACT_KIND = "BINANCE_OKX_OVERLAP_TAKER_FLOW_MOMENTUM_CONTINUATION_CLOSURE_RECORD"

EVALUATOR_PATH = "artifacts/strategy_evaluations/binance_okx_overlap_taker_flow_momentum_continuation_evaluator_v1.json"
EXECUTION_PATH = "artifacts/strategy_executions/binance_okx_overlap_taker_flow_momentum_continuation_execution_v1.json"
EVALUATOR_STATUS = "PASS_REPO_ONLY_BINANCE_OKX_OVERLAP_TAKER_FLOW_MOMENTUM_CONTINUATION_EVALUATED"
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_BINANCE_OKX_OVERLAP_TAKER_FLOW_MOMENTUM_CONTINUATION_EXECUTED"
EVALUATOR_PAYLOAD_HASH = "edf4e70af07285013f995d8d96692d7c131821b8b3497f2b19b6ab11e8a856e2"
...
def build_closure() -> Dict[str, Any]:
    ...
    route_closed = True
    closure_reason = (
        f"The taker-flow momentum continuation route is closed with result_class={result_class}. "
    ...
    payload: Dict[str, Any] = {
        ...
        "prior_execution_result_preserved": {
            ...
            "train_eligible_timestamp_count": execution["signal_coverage_summary"]["train_eligible_timestamp_count"],
            "validation_eligible_timestamp_count": execution["signal_coverage_summary"]["validation_eligible_timestamp_count"],
            "average_eligible_symbols_per_timestamp": execution["signal_coverage_summary"]["average_eligible_symbols_per_timestamp"],
            "top_symbol_exposure_share": execution["turnover_concentration_summary"]["top_symbol_exposure_share"],
            ...
            "signal_coverage_review_preliminary_passed": execution["signal_coverage_summary"]["signal_coverage_review_preliminary_passed"],
        ...
        "closure_record": {
            ...
            "closure_type": "TAKER_FLOW_MOMENTUM_CONTINUATION_CLOSURE_AFTER_EVALUATOR",
        ...
        "project_state_after_closure": {
            "taker_flow_momentum_continuation_route_closed": route_closed,
            "no_active_candidate_exists": True,
            "no_active_edge_claim_exists": True,
            "no_family_release_exists": True,
...
def main() -> None:
    ...
    summary = {
        ...
        "signal_coverage_review_passed": artifact["closure_record"]["signal_coverage_review_passed"],
