...
MODULE_PATH = "tools/edge_factory_os_repo_only_lucifer_15m_v2_preregistration_contract_v1.py"
...
def build_payload() -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "next_module": "tools/edge_factory_os_repo_only_lucifer_15m_v2_execution_v1.py",
        "validation_checks": {
