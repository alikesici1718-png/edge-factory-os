...
POSTMORTEM_V2 = REPO_ROOT / "artifacts" / "strategy_reviews" / "crypto_15m_residual_sweep_confirmation_postmortem_diagnostic_v2.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_residual_sweep_confirmation_short_only_v2_preregistration_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_PREREGISTRATION_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_PREREGISTRATION"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v2_preregistration_v1.py",
        "?? artifacts/research_preregistrations/crypto_15m_residual_sweep_confirmation_short_only_v2_preregistration_v1.json",
    }
    ...
    preregistered_config = {
        ...
        "v2_change": "Disable long entries entirely; short setup and all inherited fixed parameters remain unchanged.",
        "parameter_grid_allowed": False,
        "optimization_allowed": False,
        "postmortem_justification": {
            "source": str(POSTMORTEM_V2),
            "v2_direction_classification": postmortem.get("v2_direction_assessment", {}).get("v2_direction_classification"),
            "side_diagnostic_classification": postmortem.get("side_performance_diagnostic", {}).get("side_diagnostic_classification"),
            "suggested_boundary": postmortem.get("suggested_v2_boundaries", {}).get("suggested_v2_boundary"),
        },
        "dataset": {
        ...
        "disabled_long_side_policy": {
            ...
            "no_short_parameter_change_from_long_diagnostics": True,
        },
        "entry_exit": {
        ...
        "evaluator_policy": {
            ...
            "allowed_result_classes": [
                "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE",
                "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_REJECTED_NO_FOLLOWUP",
                "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_INCONCLUSIVE_NEEDS_MORE_DATA",
                "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V2_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE",
            ],
        },
    }
    safety_permissions = {
    ...
    validation_checks = {
        ...
        "v2_direction_verified_short_only": postmortem.get("v2_direction_assessment", {}).get("v2_direction_classification") == "V2_DIRECTION_JUSTIFIED_SHORT_ONLY",
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v2_preregistration_v1",
        "strategy": STRATEGY,
        "route_family": ROUTE_FAMILY,
        "config_id": CONFIG_ID,
        "source_checkpoint": {
    ...
    print("long_entries_enabled: false")
