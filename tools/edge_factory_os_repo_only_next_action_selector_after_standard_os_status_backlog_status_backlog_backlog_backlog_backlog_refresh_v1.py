...
MODULE_NAME = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "174859e"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"

BACKLOG_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.json"
BACKLOG_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_post_commit_check_latest.json"
QUEUE_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1" / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.json"
QUEUE_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_post_commit_check_latest.json"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": True,
    "read_only_next_action_selection_only": True,
    "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_required": True,
    "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_allowed_next": True,
...
INPUTS: Dict[str, Tuple[Path, str, Optional[str]]] = {
    ...
    "development_queue_selector": (
        ...
        "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py",
    ),
    "development_queue_selector_post_check": (
        QUEUE_POST_JSON,
        "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py",
    ),
}
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if git_state["untracked_paths"] != expected_untracked:
        errors.append(f"unexpected untracked set before selector: expected={expected_untracked} actual={git_state['untracked_paths']}")
    ...
    if subject != "Add repo-only development backlog refresh after standard OS status backlog status backlog backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"]:
    ...
    backlog_post = source_statuses.get("development_backlog_post_check", {})
    if backlog_post.get("latest_commit") != EXPECTED_HEAD:
        errors.append(f"backlog post-check latest_commit mismatch: expected={EXPECTED_HEAD} actual={backlog_post.get('latest_commit')}")
    if backlog_post.get("git_head") != EXPECTED_HEAD:
        errors.append(f"backlog post-check git head mismatch: expected={EXPECTED_HEAD} actual={backlog_post.get('git_head')}")

    backlog_obj = loaded.get("development_backlog", {})
    backlog = backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh", {})
    selected_item = backlog.get("selected_next_backlog_item", {}) if isinstance(backlog, dict) else {}
    if selected_item.get("module") != APPROVED_CURRENT_MODULE:
        errors.append(f"backlog selected module mismatch: expected={APPROVED_CURRENT_MODULE} actual={selected_item.get('module')}")
    if selected_item.get("allowed") is not True:
        errors.append("backlog selected item is not allowed")
    if selected_item.get("scope") != "REPO_ONLY_OS_INTELLIGENCE":
        errors.append(f"backlog selected item scope mismatch: {selected_item.get('scope')}")
    ...
    if py["tracked_python_file_count"] != 517:
        errors.append(f"tracked Python count mismatch: expected=517 actual={py['tracked_python_file_count']}")

    physical_after = physical_guard_snapshot()
    if physical_after["planned_schema_file_existing_count"] != 0:
        errors.append(f"planned schema files existed after selector: {physical_after['existing_planned_schema_files']}")
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    backlog_obj = validation["loaded"].get("development_backlog", {})
    backlog = backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh", {})
    selected_item = backlog.get("selected_next_backlog_item", {}) if isinstance(backlog, dict) else {}
    backlog_context = backlog.get("context_summary", {}) if isinstance(backlog, dict) else {}
    effective_schema_state = backlog_context.get("effective_schema_state", {})
    effective_approval_state = backlog_context.get("effective_approval_state", {})

    queue_obj = validation["loaded"].get("development_queue_selector", {})
    queue = queue_obj.get("development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh", {})
    selected_queue_task = queue.get("selected_development_task", {}) if isinstance(queue, dict) else {}

    physical_after = validation["physical_after"]
    prerequisites = {
        "backlog_ready": backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status") == "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        "backlog_selected_this_selector": backlog_obj.get("next_module") == APPROVED_CURRENT_MODULE,
        "backlog_selected_this_selector_item": selected_item.get("module") == APPROVED_CURRENT_MODULE,
        "selected_item_allowed": selected_item.get("allowed") is True,
        "selected_item_repo_only_scope": selected_item.get("scope") == "REPO_ONLY_OS_INTELLIGENCE",
        "queue_ready": queue_obj.get("development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status") == "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        "queue_selected_backlog_refresh": selected_queue_task.get("module") == "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py",
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "Backlog refresh is clean; select next repo-only development queue task.",
            "blocked_actions": [
    ...
    return {
        "selector_status": "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        "candidate_actions": candidate_actions,
        "candidate_action_count": len(candidate_actions),
        "selected_action": selected,
        "selected_next_module": selected["module"] if selected else None,
        "selected_next_action": "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        "selected_scope": selected["scope"] if selected else None,
        "prerequisites": prerequisites,
        "context_summary": {
            "backlog_status": backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status"),
            "backlog_selected_module": selected_item.get("module"),
            ...
            "source_context": backlog_context,
        ...
        "invariants": {
            ...
            "selected_module_is_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status": "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "NEXT_ACTION_SELECTED_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH" if passed else "KEEP_FREEZE_REVIEW_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Selected repo-only development queue selector after standard OS status backlog status backlog backlog backlog backlog refresh; schema apply/create/edit remain blocked and physically absent." if passed else "Next-action selector after standard OS status backlog status backlog backlog backlog backlog refresh validation failed.",
        ...
        "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": selector,
    ...
    latest_json = OUT_DIR / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.txt"
    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY NEXT ACTION SELECTOR AFTER STANDARD OS STATUS BACKLOG STATUS BACKLOG BACKLOG BACKLOG BACKLOG REFRESH v1",
        "=" * 100,
        f"status: {payload['next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status']}",
