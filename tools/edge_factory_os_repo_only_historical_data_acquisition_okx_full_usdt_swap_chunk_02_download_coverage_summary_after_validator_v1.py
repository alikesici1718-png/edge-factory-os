...
MODULE_NAME = "edge_factory_os_repo_only_historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_coverage_summary_after_validator_v1"
REQUESTED_MODULE = f"{MODULE_NAME}.py"
EXPECTED_HEAD = "ac11a9e"
PREVIOUS_STATUS = "PASS_HISTORICAL_DATA_ACQUISITION_OKX_FULL_USDT_SWAP_CHUNK_02_DOWNLOAD_VALIDATED_WITH_COVERAGE_GAPS_COVERAGE_SUMMARY_READY_NO_BUILD"
PASS_STATUS = "PASS_HISTORICAL_DATA_ACQUISITION_OKX_FULL_USDT_SWAP_CHUNK_02_COVERAGE_SUMMARY_CLOSED_GENERIC_CHUNK_CONTROLLER_PREVIEW_READY"
BLOCKED_STATUS = "BLOCKED_HISTORICAL_DATA_ACQUISITION_OKX_FULL_USDT_SWAP_CHUNK_02_DOWNLOAD_COVERAGE_SUMMARY_FAILED"
NEXT_MODULE = "edge_factory_os_repo_only_historical_data_acquisition_okx_full_usdt_swap_generic_chunk_coverage_controller_preview_after_chunk_02_summary_v1.py"
FAILED_NEXT_MODULE = "edge_factory_os_repo_only_historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_coverage_summary_blocked_record_v1.py"
AFTER_QUALITY = "HISTORICAL_DATA_ACQUISITION_OKX_FULL_USDT_SWAP_CHUNK_02_COVERAGE_SUMMARY_CLOSED_GENERIC_CHUNK_CONTROLLER_PREVIEW_READY"
...
VALIDATOR_DIR = EDGE_LAB_ROOT / "edge_factory_os_repo_only_historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_execution_validator_after_execution_v1"
...
ARTIFACTS = {
    "validator_summary": VALIDATOR_DIR / "historical_okx_full_usdt_swap_chunk_02_download_execution_validator_summary.json",
    "per_symbol_validation": VALIDATOR_DIR / "historical_okx_full_usdt_swap_chunk_02_per_symbol_coverage_validation_report.json",
    "gap_validation": VALIDATOR_DIR / "historical_okx_full_usdt_swap_chunk_02_gap_validation_report.json",
...
REQUIRED_OUTPUTS = [
    ...
    "historical_okx_full_usdt_swap_chunk_02_coverage_eligible_symbols.json",
    "historical_okx_full_usdt_swap_chunk_02_coverage_gap_symbols.json",
    "historical_okx_full_usdt_swap_cumulative_coverage_eligibility_ledger_after_chunk_02.json",
    "historical_okx_full_usdt_swap_cumulative_coverage_eligible_symbols_after_chunk_02.json",
    "historical_okx_full_usdt_swap_cumulative_coverage_gap_symbols_after_chunk_02.json",
    "historical_okx_full_usdt_swap_generic_chunk_coverage_controller_preview_approval_record.json",
    "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary_self_validator.json",
    "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary_bundle_summary.json",
]
...
FINAL_AVAILABLE_FILE_COUNT = 13_053
MISSING_OR_FAILED_FILE_COUNT = 8_007
CHUNK_01_COMPLETE_SYMBOLS = [
    "1INCH-USDT-SWAP",
    "AAVE-USDT-SWAP",
    "ADA-USDT-SWAP",
    "AGLD-USDT-SWAP",
...
CHUNK_01_AVAILABLE_FILE_COUNT = 10_106
CHUNK_01_MISSING_OR_FAILED_FILE_COUNT = 10_954
CHUNK_01_PLANNED_FILE_COUNT = 21_060
...
def validate_inputs(artifacts: dict[str, dict[str, Any]], py_state: dict[str, Any]) -> dict[str, bool]:
    ...
    checks = {
        ...
        "validator_status_passed": validator.get("historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_execution_validator_status") == PREVIOUS_STATUS,
        "current_next_module_matches": validator.get("next_module") == REQUESTED_MODULE,
        "validator_allows_summary": validator.get("chunk_download_validated_for_coverage_summary") is True,
        ...
        "chunk_plan_valid": (
            ...
            and chunk_plan["chunks"][0].get("chunk_id") == "chunk_01"
        ...
        "chunk_01_ledger_valid": (
            ...
            and chunk_01_ledger.get("chunks_remaining") == 15
            and chunk_01_ledger.get("symbols_evaluated_for_download_coverage") == 20
            and chunk_01_ledger.get("cumulative_near_3y_download_coverage_complete_symbol_count") == len(CHUNK_01_COMPLETE_SYMBOLS)
            and chunk_01_ledger.get("cumulative_coverage_gap_symbol_count") == len(CHUNK_01_GAP_SYMBOLS)
            and chunk_01_ledger.get("cumulative_pending_symbol_count") == 283
            and chunk_01_ledger.get("cumulative_available_file_count") == CHUNK_01_AVAILABLE_FILE_COUNT
            and chunk_01_ledger.get("cumulative_missing_or_failed_file_count") == CHUNK_01_MISSING_OR_FAILED_FILE_COUNT
            and chunk_01_ledger.get("cumulative_planned_file_count_evaluated") == CHUNK_01_PLANNED_FILE_COUNT
            and chunk_01_ledger.get("build_ready_symbol_count") == 0
            and chunk_01_ledger.get("acquisition_ready_symbol_count") == 0
        ),
...
def common_summary(artifacts: dict[str, dict[str, Any]], checks: dict[str, bool], py_state: dict[str, Any]) -> dict[str, Any]:
    validator = artifacts["validator_summary"]
    evaluated_count = CHUNK_SYMBOL_COUNT * CHUNKS_COMPLETED
    pending_count = TOTAL_CANDIDATE_SYMBOL_COUNT - evaluated_count
    cumulative_complete_count = len(CHUNK_01_COMPLETE_SYMBOLS) + len(FULL_COVERAGE_SYMBOLS)
    cumulative_gap_count = len(CHUNK_01_GAP_SYMBOLS) + len(GAP_SYMBOLS)
    cumulative_available_count = CHUNK_01_AVAILABLE_FILE_COUNT + FINAL_AVAILABLE_FILE_COUNT
    cumulative_missing_count = CHUNK_01_MISSING_OR_FAILED_FILE_COUNT + MISSING_OR_FAILED_FILE_COUNT
    cumulative_planned_count = CHUNK_01_PLANNED_FILE_COUNT + PLANNED_FILE_COUNT
    replacement_checks = {
        **checks,
        ...
        "cumulative_counts_valid": cumulative_complete_count + cumulative_gap_count + pending_count == TOTAL_CANDIDATE_SYMBOL_COUNT,
        "cumulative_file_counts_valid": cumulative_available_count + cumulative_missing_count == cumulative_planned_count,
        "no_download_api_browse_build_aggregation_now": True,
        "next_route_is_generic_controller_preview": True,
        "approval_record_created": True,
    }
    replacement_checks_all_true = all(replacement_checks.values())
    return {
        "historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_coverage_summary_status": PASS_STATUS if replacement_checks_all_true else BLOCKED_STATUS,
        ...
        "generic_chunk_controller_preview_required": True,
        "generic_chunk_controller_preview_approval_record_created": replacement_checks_all_true,
        "approval_grants_chunk_02_coverage_summary_now": replacement_checks_all_true,
        "approval_grants_generic_chunk_controller_now": False,
        "approval_grants_future_generic_chunk_controller_preview_next": replacement_checks_all_true,
        ...
        "current_evidence_chain_quality_after_summary": AFTER_QUALITY if replacement_checks_all_true else "CHUNK_02_COVERAGE_SUMMARY_FAILED_CLOSED",
...
def build_outputs(summary: dict[str, Any], artifacts: dict[str, dict[str, Any]]) -> dict[str, Any]:
    pending_chunks = artifacts["chunk_plan"]["chunks"][2:]
    cumulative_eligible_symbols = CHUNK_01_COMPLETE_SYMBOLS + FULL_COVERAGE_SYMBOLS
    cumulative_gap_symbols = CHUNK_01_GAP_SYMBOLS + GAP_SYMBOLS
    eligible = {
        **summary,
        "artifact_type": "chunk_02_coverage_eligible_symbols",
        "eligible_symbols": [
            {
                "symbol": symbol,
    ...
    gaps = {
        **summary,
        "artifact_type": "chunk_02_coverage_gap_symbols",
    ...
    ledger = {
        **summary,
        "artifact_type": "cumulative_coverage_eligibility_ledger_after_chunk_02",
        "ledger_entries": {
            "near_3y_download_coverage_complete_symbols": cumulative_eligible_symbols,
            "coverage_gap_symbols": cumulative_gap_symbols,
    ...
    cumulative_eligible = {
        **summary,
        "artifact_type": "cumulative_coverage_eligible_symbols_after_chunk_02",
        "eligible_symbols": [
            {
                "symbol": symbol,
                "near_3y_download_coverage_complete": True,
            ...
            for symbol in cumulative_eligible_symbols
        ],
    }
    cumulative_gaps = {
        **summary,
        "artifact_type": "cumulative_coverage_gap_symbols_after_chunk_02",
        "coverage_gap_symbols": [
            {
                "symbol": symbol,
                "near_3y_download_coverage_complete": False,
            ...
            for symbol in cumulative_gap_symbols
        ],
    }
    approval = {
        **summary,
        "artifact_type": "generic_chunk_coverage_controller_preview_approval_record",
        "approval_scope": "next generic chunk coverage controller preview only",
        "chunks_start": "chunk_03",
        "chunks_end": "chunk_16",
        "chunks_remaining_after_chunk_02": CHUNKS_REMAINING,
        "total_pending_symbols": summary["cumulative_pending_symbol_count"],
        "pending_chunk_ids": [chunk["chunk_id"] for chunk in pending_chunks],
        "download_execution_still_chunk_bounded": True,
        "all_at_once_full_universe_download_allowed": False,
        "every_chunk_keeps_preview_execution_validator_summary_gates": True,
        "controller_may_standardize_module_repetition": True,
    }
    self_validator = {
        **summary,
        "artifact_type": "coverage_summary_self_validator",
        "required_outputs": REQUIRED_OUTPUTS,
        "validator_source_status": artifacts["validator_summary"].get("historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_execution_validator_status"),
    }
    coverage_summary = {
        **summary,
        "artifact_type": "chunk_02_download_coverage_summary",
        "per_symbol_coverage_validation_source": str(ARTIFACTS["per_symbol_validation"]),
    }
    bundle_summary = {
        **summary,
        "artifact_type": "chunk_02_download_coverage_summary_bundle_summary",
        "artifact_count": len(REQUIRED_OUTPUTS),
    }
    return {
        "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary.json": coverage_summary,
        "historical_okx_full_usdt_swap_chunk_02_coverage_eligible_symbols.json": eligible,
        "historical_okx_full_usdt_swap_chunk_02_coverage_gap_symbols.json": gaps,
        "historical_okx_full_usdt_swap_cumulative_coverage_eligibility_ledger_after_chunk_02.json": ledger,
        "historical_okx_full_usdt_swap_cumulative_coverage_eligible_symbols_after_chunk_02.json": cumulative_eligible,
        "historical_okx_full_usdt_swap_cumulative_coverage_gap_symbols_after_chunk_02.json": cumulative_gaps,
        "historical_okx_full_usdt_swap_generic_chunk_coverage_controller_preview_approval_record.json": approval,
        "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary_self_validator.json": self_validator,
        "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary_bundle_summary.json": bundle_summary,
    }
...
def blocked_payload(message: str) -> dict[str, Any]:
    return {
        "historical_data_acquisition_okx_full_usdt_swap_chunk_02_download_coverage_summary_status": BLOCKED_STATUS,
        ...
        "generic_chunk_controller_preview_required": False,
        "generic_chunk_controller_preview_approval_record_created": False,
        "approval_grants_future_generic_chunk_controller_preview_next": False,
        "full_universe_download_allowed_now": False,
        "data_build_allowed_now": False,
        "strategy_backtest_edge_allowed_now": False,
        "active_p0_blocker_count": 1,
        "active_p1_attention_count": 505,
        "current_evidence_chain_quality_after_summary": "CHUNK_02_COVERAGE_SUMMARY_FAILED_CLOSED",
...
def main() -> int:
    try:
        ...
        write_json(OUTPUT_DIR / "historical_okx_full_usdt_swap_chunk_02_download_coverage_summary_bundle_summary.json", blocked)
