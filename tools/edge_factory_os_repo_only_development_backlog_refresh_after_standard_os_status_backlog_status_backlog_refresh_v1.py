...
MODULE_NAME = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "0a9fbe1"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh": True,
    "read_only_backlog_refresh_only": True,
    "autopilot_until_research_gate_required": True,
    "development_queue_selector_after_standard_os_status_backlog_status_backlog_refresh_required": True,
    "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_allowed_next": True,
...
INPUTS: Dict[str, Tuple[Path, str, Optional[str]]] = {
    "autopilot": (AUTOPILOT_JSON, "PASS", "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_refresh_v1.py"),
    "autopilot_post_check": (
        AUTOPILOT_POST_JSON,
        "REPO_ONLY_AUTOPILOT_UNTIL_RESEARCH_GATE_POST_COMMIT_CHECK_PASS",
        "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_refresh_v1.py",
    ),
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development queue selector after standard OS status backlog status backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_refresh_v1.py"]:
    ...
    if autopilot_post.get("latest_commit") != "a3c12b2":
        errors.append(f"autopilot post-check latest_commit mismatch: expected=a3c12b2 actual={autopilot_post.get('latest_commit')}")
    ...
    if py["tracked_python_file_count"] != 510:
        errors.append(f"tracked Python count mismatch: expected=510 actual={py['tracked_python_file_count']}")
...
def build_backlog(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "selector_selected_queue": selected_action.get("module") == "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_refresh_v1.py",
    ...
    backlog_items = [
        {
            "rank": 1,
            "key": "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "Backlog refreshed after autopilot-approved standard OS status backlog status backlog refresh; select next repo-only action selector.",
            "blocked_actions": [
    ...
    return {
        "development_backlog_status": "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        ...
        "invariants": {
            ...
            "selected_module_is_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_READY_FOR_NEXT_ACTION_SELECTOR" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Development backlog refreshed after autopilot-approved standard OS status backlog status backlog refresh; schema apply/create/edit remain blocked and physically absent." if passed else "Development backlog refresh after standard OS status backlog status backlog refresh validation failed.",
        ...
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh": backlog,
    ...
    latest_json = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_v1_latest.txt"
    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY DEVELOPMENT BACKLOG REFRESH AFTER STANDARD OS STATUS BACKLOG STATUS BACKLOG REFRESH v1",
        "=" * 100,
        f"status: {payload['development_backlog_refresh_after_standard_os_status_backlog_status_backlog_refresh_status']}",
