...
MODULE_NAME = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "825af77"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh": True,
    "read_only_next_action_selection_only": True,
    "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_required": True,
    "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_allowed_next": True,
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development backlog refresh after standard OS status backlog status backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"]:
    ...
    backlog = backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh", {})
    ...
    if py["tracked_python_file_count"] != 514:
        errors.append(f"tracked Python count mismatch: expected=514 actual={py['tracked_python_file_count']}")
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        "backlog_ready": backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_status") == "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1_READY",
        ...
        "queue_selected_backlog_refresh": selected_queue_task.get("module") == "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py",
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH",
    ...
    return {
        "selector_status": "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        "candidate_actions": candidate_actions,
        "candidate_action_count": len(candidate_actions),
        "selected_action": selected,
        "selected_next_module": selected["module"] if selected else None,
        "selected_next_action": "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        "selected_scope": selected["scope"] if selected else None,
        "prerequisites": prerequisites,
        "context_summary": {
            "backlog_status": backlog_obj.get("development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_status"),
        ...
        "invariants": {
            ...
            "selected_module_is_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status": "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "NEXT_ACTION_SELECTED_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH" if passed else "KEEP_FREEZE_REVIEW_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        ...
        "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh": selector,
    ...
    latest_json = OUT_DIR / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.txt"
    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY NEXT ACTION SELECTOR AFTER STANDARD OS STATUS BACKLOG STATUS BACKLOG BACKLOG BACKLOG REFRESH v1",
        "=" * 100,
        f"status: {payload['next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status']}",
