...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_residual_sweep_confirmation_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_EVALUATION"
...
PROMISING = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_residual_sweep_confirmation_evaluator_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_evaluator_v1",
        "strategy": STRATEGY,
