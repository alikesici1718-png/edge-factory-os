...
PREREGISTRATION_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_preregistration_v1.json"
...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_execution_v1.json"

STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_WIDER_STOP_EXECUTED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_WIDER_STOP_EXECUTION"
...
PREREGISTRATION_STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_WIDER_STOP_PREREGISTRATION_CREATED"
STOP_BUFFER_ATR = 1.0
...
def wider_stop_build_candidate(
    side: str,
    symbol: str,
    idx: int,
    master_idx: int,
    ...
    if notional <= 0 or not math.isfinite(notional):
        return None, "invalid_risk"
    exit_result = base.simulate_exit(side, entry_idx, timestamps, opens, highs, lows, stop, take)
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_execution_v1.py",
        "?? artifacts/strategy_executions/crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_execution_v1.json",
    }
    ...
    trap.mpv.v3.v2.base.build_candidate = wider_stop_build_candidate
    try:
    ...
    metrics["wider_stop_valid_count"] = counters["cost_aware_gate_passed_short"]
    ...
    integrity_checks = {
        ...
        "wider_stop_buffer_atr_1p0_enforced": all(value == STOP_BUFFER_ATR for value in accepted_stop_buffers) if accepted_stop_buffers else True,
        "wider_stop_computed_before_entry_acceptance": True,
        "risk_quality_gate_prior_to_acceptance": True,
        "risk_quality_gate_computed_after_wider_stop": True,
    ...
    validation_checks = {
        ...
        "only_stop_buffer_changed": True,
        "trap_quality_score_min_3_unchanged": True,
        "stop_buffer_atr_1p0_applied": True,
        "risk_quality_ratio_min_1p0_restored": True,
    ...
    artifact = {
        ...
        "only_changed_parameter": {
            "field": "stop_buffer_atr",
            "prior_value": 0.5,
            "new_value": STOP_BUFFER_ATR,
        ...
        "data_limitations": [
            "Execution reuses the exact prior trap-quality stack and changes only the short stop buffer from 0.5 ATR14 to 1.0 ATR14.",
    ...
    print(f"wider_stop_valid_count: {metrics['wider_stop_valid_count']}")
