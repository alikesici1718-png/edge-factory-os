...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_time_exit_only_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_time_exit_only_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_EXECUTED"

PROMISING = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_TIME_EXIT_ONLY_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_quality_time_exit_only_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_idiosyncratic_sweep_short_trap_quality_time_exit_only_evaluator_v1.json",
    }
    ...
    if metrics.get("stop_buffer_atr") != 0.5:
        invalidated_reasons.append("stop_buffer_atr_not_0p5")
    if metrics.get("take_profit_enabled") is not False or metrics.get("take_profit_exit_count") != 0:
        invalidated_reasons.append("take_profit_not_removed")
    if metrics.get("exit_rule") != "stop_or_time_only":
        invalidated_reasons.append("exit_rule_not_stop_or_time_only")
    ...
    checks = {
        ...
        "stop_buffer_atr_0p5_verified": metrics.get("stop_buffer_atr") == 0.5,
        "take_profit_removed_verified": metrics.get("take_profit_enabled") is False and metrics.get("take_profit_exit_count") == 0,
        "time_exit_only_metric_present": metrics.get("time_exit_only_valid_count") is not None,
    ...
    artifact = {
        ...
        "execution_metric_summary": {
            "time_exit_only_valid_count": metrics.get("time_exit_only_valid_count"),
            "stop_buffer_atr": metrics.get("stop_buffer_atr"),
            "take_profit_enabled": metrics.get("take_profit_enabled"),
            "exit_rule": metrics.get("exit_rule"),
            ...
            "comparison_deltas_versus_rejection_depth": execution.get("rejection_depth_comparison_deltas"),
        },
