...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_EXECUTED"

PROMISING = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_evaluator_v1.json",
    }
    ...
    if metrics.get("risk_quality_ratio_min") != 1.5:
        invalidated_reasons.append("risk_quality_ratio_min_not_1p5")
    ...
    checks = {
        ...
        "risk_quality_ratio_min_verified_1p5": metrics.get("risk_quality_ratio_min") == 1.5,
        "risk_quality_tightened_metric_present": metrics.get("risk_quality_tightened_blocked") is not None,
        "trap_quality_metric_present": metrics.get("trap_quality_passed_count") is not None,
        "confirmation_quality_metric_present": metrics.get("confirmation_quality_passed_count") is not None,
    ...
    artifact = {
        ...
        "execution_metric_summary": {
            "risk_quality_tightened_blocked": metrics.get("risk_quality_tightened_blocked"),
            "risk_quality_tightened_gate_passed": metrics.get("risk_quality_tightened_gate_passed"),
