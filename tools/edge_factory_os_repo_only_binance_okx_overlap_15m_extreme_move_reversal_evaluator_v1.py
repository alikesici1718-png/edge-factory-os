...
MODULE_PATH = "tools/edge_factory_os_repo_only_binance_okx_overlap_15m_extreme_move_reversal_evaluator_v1.py"
ARTIFACT_PATH = "artifacts/strategy_evaluations/binance_okx_overlap_15m_extreme_move_reversal_evaluator_v1.json"
STATUS = "PASS_REPO_ONLY_BINANCE_OKX_OVERLAP_15M_EXTREME_MOVE_REVERSAL_EVALUATED"
ARTIFACT_KIND = "BINANCE_OKX_OVERLAP_15M_EXTREME_MOVE_REVERSAL_EVALUATION"
...
PREREG_PAYLOAD_HASH = "f7bd65b67f28d9c679fb6fcfac6df782fcd3dca06eb3ab6640208f35d59ccff1"
...
def build_evaluation() -> Dict[str, Any]:
    ...
    coverage = execution["event_coverage_summary"]
    ...
    coverage_passed = coverage["validation_event_coverage_review_preliminary_passed"]
    ...
    result_reason = (
        f"The single preregistered 15m extreme-move reversal config produced validation gross metric "
        ...
        f"monthly_stability_passed={monthly_passed}, event_coverage_passed={coverage_passed}, "
    ...
    payload: Dict[str, Any] = {
        ...
        "prior_execution_preserved": {
            ...
            "holdout_event_count": config["holdout_event_count"],
        ...
        "evaluation_policy": {
            "diagnostic_promising_requires_all": [
                ...
                "validation_event_coverage_review_preliminary_passed is true",
            ...
            "holdout_policy": {
                ...
                "holdout_cannot_create_candidate_edge_or_release": True,
            },
        },
        ...
        "event_coverage_findings": {
            "train_event_count": coverage["train_event_count"],
            "validation_event_count": coverage["validation_event_count"],
            "holdout_event_count": coverage["holdout_event_count"],
            "total_event_count": coverage["total_event_count"],
            "top_symbol_event_share": coverage["top_symbol_event_share"],
            "average_events_per_symbol": coverage["average_events_per_symbol"],
            "validation_event_coverage_review_preliminary_passed": coverage_passed,
        },
        "side_performance_findings": {
            "long_validation_event_count": side["long_validation_event_count"],
            "short_validation_event_count": side["short_validation_event_count"],
        ...
        "evaluator_findings": {
            ...
            "event_coverage_review_passed": coverage_passed,
        ...
        "validation_checks": {
            ...
            "preregistration_payload_hash_verified": prereg_hash == PREREG_PAYLOAD_HASH,
