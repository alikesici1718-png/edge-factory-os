...
MODULE_NAME = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME

EXPECTED_HEAD = "6d2a85e"
EXPECTED_TRACKED_PYTHON_COUNT = 543
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"
PRIOR_COMMIT_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"

PRIOR_SELECTOR_JSON = (
    LAB_ROOT
    / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1"
    / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.json"
)
PRIOR_POST_CHECK_CANDIDATES = [
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check"
        / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_post_commit_check"
        / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
]

REQUIRED_PRIOR_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
REQUIRED_PRIOR_POST_CHECK_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS"
REQUIRED_PRIOR_NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
REQUIRED_PRIOR_NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"
REQUIRED_PRIOR_FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_EVALUATED_READY_FOR_DEVELOPMENT_QUEUE_SELECTOR"

READY_STATUS = "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_QUEUE_SELECTED_READY_FOR_BACKLOG_REFRESH"
NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
NEXT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh": True,
    "development_queue_selector_only": True,
    "read_only_prior_selector_evidence_validation_only": True,
    "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_allowed_next": True,
...
def prior_selector_route_object(prior_obj: Dict[str, Any]) -> Dict[str, Any]:
    route = prior_obj.get("next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh", {})
    return route if isinstance(route, dict) else {}


def validate_prior_selector_record(errors: List[str], prior_obj: Dict[str, Any]) -> None:
    if prior_obj.get("next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") != REQUIRED_PRIOR_STATUS:
        errors.append(
            "prior next-action selector status mismatch: "
            f"{prior_obj.get('next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status')}"
        )
...
def validate_prior_selector_route(errors: List[str], prior_obj: Dict[str, Any]) -> None:
    ...
    if not isinstance(selected, dict):
        ...
        return
    if selected.get("key") != "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH":
...
def derive_live_repo_post_check(
    ...
    replacement_checks = {
        ...
        "prior_selector_json_ready": prior_obj.get("next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_PRIOR_STATUS,
    ...
    return {
        "audit_status": REQUIRED_PRIOR_POST_CHECK_STATUS if not errors else "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_FAIL",
...
def load_or_derive_prior_post_check(
    ...
    if artifact is not None:
        ...
        obj["derived_live_repo_post_check"] = False
        obj["derived_live_repo_post_check_reason"] = "Expected prior post-check JSON artifact was present and loaded."
        obj["derived_live_repo_post_check_replacement_checks"] = {}
        obj["post_check_artifact_path"] = str(artifact)
        return obj
    return derive_live_repo_post_check(git_state, tracked_python, prior_obj)
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only next action selector after generic governance blocked status backlog status backlog refresh":
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "prior_next_action_selector_ready": prior_obj.get("next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_PRIOR_STATUS,
        ...
        "prior_selector_selected_development_queue_route": prior_selected.get("key") == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
            "module": NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "The prior selector routed here and all blocked generic governance paths remain blocked; queue the repo-only development backlog refresh as the next safe step.",
            "blocked_actions": [
        ...
        },
        {
            ...
            "allowed": False,
            "reason": "Generic runner implementation remains blocked and cannot be selected.",
    ...
    return {
        "selector_status": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        ...
        "confirmed_proofs": {
            ...
            "next_action_selector_selected_repo_only_development_queue_selector_route": prior_selected.get("key") == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "invariants": {
            ...
            "selected_module_is_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh": selected is not None and selected["module"] == NEXT_MODULE,
            "selected_action_is_development_backlog_refresh": selected is not None and selected["key"] == "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
...
def build_payload(validation: Dict[str, Any], selector: Dict[str, Any], errors: List[str]) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status": READY_STATUS if passed else "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": FINAL_DECISION if passed else "KEEP_GENERIC_GOVERNANCE_BLOCKED_REVIEW_DEVELOPMENT_QUEUE_SELECTOR_AFTER_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        "next_action": NEXT_ACTION if passed else "REVIEW_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        ...
        "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh": selector,
...
def write_outputs(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    latest_json = OUT_DIR / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_{stamp}.json"
    latest_txt = OUT_DIR / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.txt"
    ...
    lines = [
        "EDGE FACTORY OS REPO-ONLY DEVELOPMENT QUEUE SELECTOR AFTER GENERIC GOVERNANCE BLOCKED STATUS BACKLOG STATUS BACKLOG REFRESH v1",
        "=" * 100,
        f"development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status: {payload['development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status']}",
        ...
        json.dumps(
            {
                "selected_action": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["selected_action"],
                "confirmed_proofs": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["confirmed_proofs"],
                "prerequisites": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["prerequisites"],
                "invariants": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["invariants"],
