...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_preregistration_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_PREREGISTRATION_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_RISK_TIGHTENED_PREREGISTRATION"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_preregistration_v1.py",
        "?? artifacts/research_preregistrations/crypto_15m_idiosyncratic_sweep_short_trap_quality_risk_tightened_preregistration_v1.json",
    }
    ...
    only_changed_parameter = {
        "field": "risk_quality_ratio_min",
        "prior_value": 1.0,
        "new_value": 1.5,
        "definition": "abs(residual_4h) / (stop_distance_fraction + total_round_trip_cost_fraction)",
        "interpretation": "Only take trades where the residual move proxy is at least 1.5x stop distance plus cost.",
        "not_a_best_bucket_threshold": True,
        "no_other_ratio_tested": True,
    }
    market_pump_veto = {
        "veto_true_if_any": [
    ...
    validation_checks = {
        ...
        "postmortem_direction_verified": postmortem.get("next_direction_assessment", {}).get("next_direction_classification") == "NEXT_DIRECTION_JUSTIFIED_RISK_QUALITY_TIGHTENING",
        ...
        "only_risk_quality_ratio_changed": True,
    ...
    artifact = {
        ...
        "postmortem_justification": {
            ...
            "exit_diagnostic": postmortem.get("exit_reason_diagnostic", {}).get("exit_diagnostic_classification"),
            "monthly_stability": postmortem.get("monthly_stability_diagnostic", {}).get("monthly_stability_classification"),
            ...
            "next_direction": postmortem.get("next_direction_assessment", {}).get("next_direction_classification"),
        },
        ...
        "preregistered_config": {
            ...
            "strategy_change_summary": "Inherited trap-quality short-only stack unchanged except risk_quality_ratio_min tightened from 1.0 to 1.5.",
    ...
    print("risk_quality_ratio_min: 1.5")
