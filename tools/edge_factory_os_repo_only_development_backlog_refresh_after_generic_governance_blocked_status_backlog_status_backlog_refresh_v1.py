...
MODULE_NAME = "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME

EXPECTED_HEAD = "0e24698"
EXPECTED_TRACKED_PYTHON_COUNT = 544
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"
PRIOR_COMMIT_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"

QUEUE_JSON = (
    LAB_ROOT
    / "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1"
    / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.json"
)
QUEUE_POST_CHECK_CANDIDATES = [
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check"
        / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_post_commit_check"
        / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
]

REQUIRED_QUEUE_STATUS = "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
REQUIRED_QUEUE_POST_CHECK_STATUS = "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS"
REQUIRED_QUEUE_NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
REQUIRED_QUEUE_NEXT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"
REQUIRED_QUEUE_FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_QUEUE_SELECTED_READY_FOR_BACKLOG_REFRESH"

READY_STATUS = "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BACKLOG_READY_FOR_NEXT_ACTION_SELECTOR"
NEXT_ACTION = "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh": True,
    "development_backlog_refresh_only": True,
    "read_only_queue_evidence_validation_only": True,
    "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_allowed_next": True,
...
def queue_route_object(queue_obj: Dict[str, Any]) -> Dict[str, Any]:
    route = queue_obj.get("development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh", {})
    return route if isinstance(route, dict) else {}


def validate_queue_record(errors: List[str], queue_obj: Dict[str, Any]) -> None:
    if queue_obj.get("development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") != REQUIRED_QUEUE_STATUS:
        errors.append(
            "development queue selector status mismatch: "
            f"{queue_obj.get('development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status')}"
        )
...
def validate_queue_route(errors: List[str], queue_obj: Dict[str, Any]) -> None:
    ...
    if not isinstance(selected, dict):
        ...
        return
    if selected.get("key") != "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH":
...
def derive_live_repo_post_check(
    ...
    replacement_checks = {
        ...
        "queue_selector_json_ready": queue_obj.get("development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_QUEUE_STATUS,
    ...
    return {
        "audit_status": REQUIRED_QUEUE_POST_CHECK_STATUS if not errors else "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_FAIL",
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development queue selector after generic governance blocked status backlog status backlog refresh":
...
def build_backlog(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "parent_queue_selector_ready": queue_obj.get("development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_QUEUE_STATUS,
        ...
        "parent_selected_backlog_refresh_key": selected_from_parent.get("key") == "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "prior_derived_live_repo_post_check_continuity_recorded": prior_derived_continuity_recorded(queue_obj) and (
    ...
    backlog_items = [
        {
            "rank": 1,
            "key": "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
            "module": NEXT_MODULE,
    ...
    return {
        "backlog_refresh_status": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_READY" if selected else "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        ...
        "confirmed_proofs": {
            ...
            "queue_selector_selected_repo_only_development_backlog_refresh_route": selected_from_parent.get("key") == "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "invariants": {
            ...
            "selected_module_is_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh": selected is not None and selected["module"] == NEXT_MODULE,
            "selected_action_is_next_action_selector": selected is not None and selected["key"] == "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
...
def build_payload(validation: Dict[str, Any], backlog: Dict[str, Any], errors: List[str]) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status": (
            READY_STATUS
            if passed
            else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED"
        ),
        ...
        "next_action": NEXT_ACTION if passed else "REVIEW_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        ...
        "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh": backlog,
...
def write_outputs(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    latest_json = OUT_DIR / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_{stamp}.json"
    latest_txt = OUT_DIR / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.txt"
    ...
    lines = [
        ...
        "=" * 100,
        f"development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status: {payload['development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status']}",
        ...
        json.dumps(
            {
                "selected_next_backlog_item": payload["development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["selected_next_backlog_item"],
                "confirmed_proofs": payload["development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["confirmed_proofs"],
                "prerequisites": payload["development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["prerequisites"],
                "invariants": payload["development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh"]["invariants"],
