...
MODULE_PATH = "tools/edge_factory_os_repo_only_binance_okx_overlap_funding_crowding_reversal_maker_entry_taker_exit_evaluator_v1.py"
ARTIFACT_PATH = "artifacts/strategy_evaluations/binance_okx_overlap_funding_crowding_reversal_maker_entry_taker_exit_evaluator_v1.json"
STATUS = "PASS_REPO_ONLY_BINANCE_OKX_OVERLAP_FUNDING_CROWDING_REVERSAL_MAKER_ENTRY_TAKER_EXIT_EVALUATED"
ARTIFACT_KIND = "BINANCE_OKX_OVERLAP_FUNDING_CROWDING_REVERSAL_MAKER_ENTRY_TAKER_EXIT_EVALUATION"
...
def build_evaluation() -> Dict[str, Any]:
    ...
    result = execution["config_result"]
    train = result["train"]
    ...
    maker_quality = execution["maker_fill_quality_summary"]
    metric_integrity = execution["metric_integrity_summary"]
    forbidden = execution["forbidden_actions_confirmed_false"]

    validation_net = validation["net_metric_bps"]
    validation_gross = validation["gross_metric_bps"]
    validation_positive = validation["positive_after_cost"]
    null_passed = null_summary["null_baseline_review_preliminary_passed"]
    monthly_passed = monthly["validation_monthly_stability_review_preliminary_passed"]
    turnover_passed = turnover["turnover_concentration_review_preliminary_passed"]
    maker_passed = (
        maker_quality["validation_executed_timestamp_count"] >= 500
        and maker_quality["long_fill_rate"] >= 0.15
        and maker_quality["short_fill_rate"] >= 0.15
        and maker_quality["average_fill_imbalance_abs"] <= 0.50
        and maker_quality["order_book_queue_not_modeled"] is True
    )
    ...
    safety_review_passed = (
        ...
        and forbidden["funding_endpoint_called_by_execution"] is False
    ...
    payload: Dict[str, Any] = {
        ...
        "prior_execution_preserved": {
            ...
            "best_config_id": execution["execution_safety_controls"]["best_config_id"],
            "train_gross_metric_bps": train["gross_metric_bps"],
            "train_net_metric_bps": train["net_metric_bps"],
            "validation_gross_metric_bps": validation_gross,
            "validation_net_metric_bps": validation_net,
            "holdout_gross_metric_bps": holdout["gross_metric_bps"],
            "holdout_net_metric_bps": holdout["net_metric_bps"],
            ...
            "train_monthly_positive_rate": monthly["train_monthly_positive_rate"],
            "validation_monthly_positive_rate": monthly["validation_monthly_positive_rate"],
            "holdout_monthly_positive_rate": monthly["holdout_monthly_positive_rate"],
        ...
        "evaluation_policy": {
            "diagnostic_promising_requires_all": [
                ...
                "validation_monthly_stability_review_preliminary_passed is true",
                "turnover_concentration_review_preliminary_passed is true",
                "maker_fill_quality_review_preliminary_passed is true",
                "metric_integrity_passed is true",
                "safety_review_passed is true",
            ],
            "maker_fill_quality_review_policy": {
                "validation_executed_timestamp_count_minimum": 500,
                "long_fill_rate_minimum": 0.15,
                "short_fill_rate_minimum": 0.15,
                "average_fill_imbalance_abs_maximum": 0.50,
                "order_book_queue_not_modeled_must_be_acknowledged": True,
            },
            "holdout_policy": {
                "holdout_reported_separately": True,
                "holdout_used_for_config_selection": False,
        ...
        "execution_results_evaluated": {
            ...
            "train_monthly_net_metric_bps_by_month": monthly["train_monthly_net_metric_bps_by_month"],
            "validation_monthly_net_metric_bps_by_month": monthly["validation_monthly_net_metric_bps_by_month"],
            "holdout_monthly_net_metric_bps_by_month": monthly["holdout_monthly_net_metric_bps_by_month"],
        },
        "maker_fill_quality_findings": {
            "maker_fill_quality_review_preliminary_passed": maker_passed,
            "validation_executed_timestamp_count": maker_quality["validation_executed_timestamp_count"],
            "long_fill_rate": maker_quality["long_fill_rate"],
            "short_fill_rate": maker_quality["short_fill_rate"],
            "average_fill_imbalance_abs": maker_quality["average_fill_imbalance_abs"],
            "average_filled_long_symbols": maker_quality["average_filled_long_symbols"],
            "average_filled_short_symbols": maker_quality["average_filled_short_symbols"],
            "order_book_queue_not_modeled": maker_quality["order_book_queue_not_modeled"],
            "adverse_selection_proxy_note": maker_quality["adverse_selection_proxy_note"],
        },
        "evaluator_findings": {
            "evaluator_ran": True,
            ...
            "validation_monthly_stability_review_passed": monthly_passed,
            "turnover_concentration_review_passed": turnover_passed,
            "maker_fill_quality_review_passed": maker_passed,
            ...
            "evaluator_reason": (
                f"Validation net metric is {validation_net} bps with validation_positive_after_cost={validation_positive}. "
                f"Maker fill quality passed={maker_passed}, but holdout is diagnostic only and cannot override validation."
            ),
        },
        ...
        "validation_checks": {
            ...
            "maker_fill_quality_policy_applied": True,
            "order_book_queue_not_modeled_acknowledged": True,
    ...
    required_assertions = [
        ...
        payload["maker_fill_quality_findings"]["order_book_queue_not_modeled"] is True,
...
def main() -> None:
    ...
    summary = {
        ...
        "maker_fill_quality_review_passed": artifact["result_classification"]["maker_fill_quality_review_passed"],
        "candidate_generation": False,
        "edge_claim": False,
        "runtime_live_capital": False,
