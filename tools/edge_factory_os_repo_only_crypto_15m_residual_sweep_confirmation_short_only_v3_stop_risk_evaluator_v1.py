...
EXECUTION_PATH = (
    ...
    / "artifacts"
    / "strategy_executions"
    / "crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_execution_v1.json"
)
ARTIFACT_PATH = (
    REPO_ROOT
    / "artifacts"
    / "strategy_evaluations"
    / "crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_evaluator_v1.json"
)

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_EVALUATION"
...
PROMISING = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_evaluator_v1.json",
    }
    ...
    criteria = {
        "validation_portfolio_net_bps_positive": is_number(validation.get("portfolio_net_bps"))
        and validation["portfolio_net_bps"] > 0,
        "holdout_portfolio_net_bps_positive": is_number(holdout.get("portfolio_net_bps"))
        and holdout["portfolio_net_bps"] > 0,
        "validation_monthly_positive_rate_gte_0_60": is_number(validation.get("monthly_positive_rate"))
        and validation["monthly_positive_rate"] >= 0.60,
        "holdout_monthly_positive_rate_gte_0_50": is_number(holdout.get("monthly_positive_rate"))
        and holdout["monthly_positive_rate"] >= 0.50,
        "validation_closed_trades_gte_30": isinstance(validation.get("closed_trades"), int)
        and validation["closed_trades"] >= 30,
    ...
    checks = {
        ...
        "stop_risk_quality_gate_present": metrics.get("stop_risk_quality_blocked") is not None
        and metrics.get("stop_risk_quality_gate_passed") is not None,
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_evaluator_v1",
        "strategy": STRATEGY,
        ...
        "execution_metric_summary": {
            "disabled_long_candidate_count": metrics.get("disabled_long_candidate_count"),
            "stop_risk_quality_blocked": metrics.get("stop_risk_quality_blocked"),
            "stop_risk_quality_gate_passed": metrics.get("stop_risk_quality_gate_passed"),
            ...
            "null_baseline": null,
            "v2_comparison_deltas": execution.get("v2_comparison_deltas"),
        },
