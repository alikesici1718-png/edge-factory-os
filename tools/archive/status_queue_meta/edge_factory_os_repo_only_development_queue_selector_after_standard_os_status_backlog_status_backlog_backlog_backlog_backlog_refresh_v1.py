...
MODULE_NAME = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "6b7cba9"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": True,
    "read_only_development_queue_selection_only": True,
    "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_required": True,
    "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_allowed_next": True,
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only next-action selector after standard OS status backlog status backlog backlog backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"]:
    ...
    selector = selector_obj.get("next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh", {})
    ...
    if py["tracked_python_file_count"] != 518:
        errors.append(f"tracked Python count mismatch: expected=518 actual={py['tracked_python_file_count']}")
...
def build_queue(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        "selector_ready": selector_obj.get("next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status") == "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        ...
        "selector_post_check_pass": validation["source_statuses"].get("next_action_selector_post_check", {}).get("status") == "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
    ...
    queue_items = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH",
    ...
    return {
        "development_queue_status": "DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        ...
        "invariants": {
            ...
            "selected_module_is_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_QUEUE_SELECTED_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        ...
        "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": queue,
    ...
    latest_json = OUT_DIR / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.txt"
