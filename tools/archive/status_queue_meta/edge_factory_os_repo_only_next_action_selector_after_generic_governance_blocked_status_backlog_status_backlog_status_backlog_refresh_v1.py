...
MODULE_NAME = "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME

EXPECTED_HEAD = "62dfd50"
EXPECTED_TRACKED_PYTHON_COUNT = 545
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1.py"
PRIOR_COMMIT_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1.py"

BACKLOG_JSON = (
    LAB_ROOT
    / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1"
    / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_latest.json"
)
BACKLOG_POST_CHECK_CANDIDATES = [
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check"
        / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_v1_post_commit_check"
        / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
]

REQUIRED_BACKLOG_STATUS = "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
REQUIRED_BACKLOG_POST_CHECK_STATUS = "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS"
REQUIRED_BACKLOG_NEXT_ACTION = "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
REQUIRED_BACKLOG_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1.py"

READY_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_EVALUATED_READY_FOR_DEVELOPMENT_QUEUE_SELECTOR"
NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh": True,
    "next_action_selector_only": True,
    "read_only_backlog_evidence_validation_only": True,
    "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_allowed_next": True,
...
def backlog_route_object(backlog_obj: Dict[str, Any]) -> Dict[str, Any]:
    route = backlog_obj.get("development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh", {})
    return route if isinstance(route, dict) else {}


def validate_backlog_record(errors: List[str], backlog_obj: Dict[str, Any]) -> None:
    if backlog_obj.get("development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") != REQUIRED_BACKLOG_STATUS:
        errors.append(
            "development backlog refresh status mismatch: "
            f"{backlog_obj.get('development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status')}"
        )
    ...
    if backlog_obj.get("final_decision") != "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BACKLOG_READY_FOR_NEXT_ACTION_SELECTOR":
...
def validate_backlog_route(errors: List[str], backlog_obj: Dict[str, Any]) -> None:
    ...
    if not isinstance(selected, dict):
        ...
        return
    if selected.get("key") != "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH":
...
def derive_live_repo_post_check(
    ...
    replacement_checks = {
        ...
        "backlog_refresh_json_ready": backlog_obj.get("development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_BACKLOG_STATUS,
    ...
    return {
        "audit_status": REQUIRED_BACKLOG_POST_CHECK_STATUS if not errors else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_FAIL",
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development backlog refresh after generic governance blocked status backlog status backlog refresh":
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "parent_backlog_refresh_ready": backlog_obj.get("development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_refresh_status") == REQUIRED_BACKLOG_STATUS,
        ...
        "parent_selected_next_action_selector_key": selected_from_parent.get("key") == "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
            "module": NEXT_MODULE,
    ...
    return {
        "selector_status": "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ACTIVE" if selected else "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        ...
        "confirmed_proofs": {
            ...
            "backlog_refresh_selected_repo_only_next_action_selector_route": selected_from_parent.get("key") == "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "invariants": {
            ...
            "selected_module_is_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh": selected is not None and selected["module"] == NEXT_MODULE,
            "selected_action_is_development_queue_selector": selected is not None and selected["key"] == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
...
def build_payload(validation: Dict[str, Any], selector: Dict[str, Any], errors: List[str]) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_status": READY_STATUS if passed else "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED",
        ...
        "next_action": NEXT_ACTION if passed else "REVIEW_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        ...
        "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh": selector,
...
def write_outputs(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    latest_json = OUT_DIR / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1_{stamp}.json"
    latest_txt = OUT_DIR / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_v1_latest.txt"
    ...
    lines = [
        ...
        "=" * 100,
        f"next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_status: {payload['next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh_status']}",
        ...
        json.dumps(
            {
                "selected_action": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh"]["selected_action"],
                "confirmed_proofs": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh"]["confirmed_proofs"],
                "prerequisites": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh"]["prerequisites"],
                "invariants": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_refresh"]["invariants"],
