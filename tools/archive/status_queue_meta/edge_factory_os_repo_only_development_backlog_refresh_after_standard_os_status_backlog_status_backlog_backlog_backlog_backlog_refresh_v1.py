...
MODULE_NAME = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "43eb7a2"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_backlog_refresh_v1.py"

QUEUE_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1" / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.json"
QUEUE_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_post_commit_check_latest.json"
SELECTOR_JSON = LAB_ROOT / "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1" / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.json"
SELECTOR_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_post_commit_check_latest.json"
PRIOR_BACKLOG_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.json"
PRIOR_BACKLOG_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_post_commit_check_latest.json"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": True,
    "read_only_backlog_refresh_only": True,
    "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_required": True,
    "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_backlog_refresh_allowed_next": True,
...
INPUTS: Dict[str, Tuple[Path, str, Optional[str]]] = {
    "development_queue_selector": (
        QUEUE_JSON,
        "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        APPROVED_CURRENT_MODULE,
    ),
    "development_queue_selector_post_check": (
        QUEUE_POST_JSON,
        "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        APPROVED_CURRENT_MODULE,
    ),
    "next_action_selector": (
        SELECTOR_JSON,
        "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py",
    ),
    "next_action_selector_post_check": (
        SELECTOR_POST_JSON,
        "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py",
    ),
    "prior_development_backlog": (
        PRIOR_BACKLOG_JSON,
        "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py",
    ),
    "prior_development_backlog_post_check": (
        PRIOR_BACKLOG_POST_JSON,
        "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py",
    ),
}
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if git_state["untracked_paths"] != expected_untracked:
        errors.append(f"unexpected untracked set before backlog refresh: expected={expected_untracked} actual={git_state['untracked_paths']}")
    ...
    if subject != "Add repo-only development queue selector after standard OS status backlog status backlog backlog backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"]:
    ...
    queue_obj = loaded.get("development_queue_selector", {})
    queue = queue_obj.get("development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh", {})
    selected_task = queue.get("selected_development_task", {}) if isinstance(queue, dict) else {}
    if selected_task.get("module") != APPROVED_CURRENT_MODULE:
        errors.append(f"queue selected module mismatch: expected={APPROVED_CURRENT_MODULE} actual={selected_task.get('module')}")
    if selected_task.get("allowed") is not True:
        errors.append("queue selected task is not allowed")
    if selected_task.get("scope") != "REPO_ONLY_OS_INTELLIGENCE":
        errors.append(f"queue selected task scope mismatch: {selected_task.get('scope')}")

    queue_post = source_statuses.get("development_queue_selector_post_check", {})
    if queue_post.get("latest_commit") != EXPECTED_HEAD:
        errors.append(f"queue post-check latest_commit mismatch: expected={EXPECTED_HEAD} actual={queue_post.get('latest_commit')}")
    if queue_post.get("git_head") != EXPECTED_HEAD:
        errors.append(f"queue post-check git head mismatch: expected={EXPECTED_HEAD} actual={queue_post.get('git_head')}")
    ...
    if py["tracked_python_file_count"] != 519:
        errors.append(f"tracked Python count mismatch: expected=519 actual={py['tracked_python_file_count']}")

    physical_after = physical_guard_snapshot()
    if physical_after["planned_schema_file_existing_count"] != 0:
        errors.append(f"planned schema files existed after backlog refresh: {physical_after['existing_planned_schema_files']}")
...
def build_backlog(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    queue = queue_obj.get("development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh", {})
    selected_task = queue.get("selected_development_task", {}) if isinstance(queue, dict) else {}
    queue_context = queue.get("context_summary", {}) if isinstance(queue, dict) else {}
    ...
    prerequisites = {
        "queue_ready": queue_obj.get("development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status") == "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY",
        "queue_selected_this_backlog_refresh": selected_task.get("module") == APPROVED_CURRENT_MODULE,
        "queue_selected_repo_only_scope": selected_task.get("scope") == "REPO_ONLY_OS_INTELLIGENCE",
        "queue_selected_allowed": selected_task.get("allowed") is True,
        "queue_post_check_pass": validation["source_statuses"].get("development_queue_selector_post_check", {}).get("status") == "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        "queue_head_current": validation["source_statuses"].get("development_queue_selector_post_check", {}).get("latest_commit") == EXPECTED_HEAD,
    ...
    backlog_items = [
        {
            "rank": 1,
            "key": "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "Backlog refreshed after standard OS status backlog status backlog backlog backlog backlog refresh; select next repo-only action selector.",
            "blocked_actions": [
    ...
    return {
        "development_backlog_status": "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        ...
        "invariants": {
            ...
            "selected_module_is_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_READY_FOR_NEXT_ACTION_SELECTOR" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Development backlog refreshed after standard OS status backlog status backlog backlog backlog backlog refresh; schema apply/create/edit remain blocked and physically absent." if passed else "Development backlog refresh after standard OS status backlog status backlog backlog backlog backlog refresh validation failed.",
        ...
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": backlog,
    ...
    latest_json = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1_latest.txt"
