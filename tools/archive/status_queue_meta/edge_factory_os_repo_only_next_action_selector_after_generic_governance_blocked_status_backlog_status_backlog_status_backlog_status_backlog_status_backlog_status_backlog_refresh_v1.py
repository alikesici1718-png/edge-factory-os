...
MODULE_NAME = "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME

EXPECTED_HEAD = "95d7f75"
EXPECTED_TRACKED_PYTHON_COUNT = 554
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
PRIOR_COMMIT_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
EXPECTED_HEAD_SUBJECT = "Add repo-only development backlog refresh after generic governance blocked status backlog status backlog status backlog status backlog status backlog refresh"

BACKLOG_JSON = (
    LAB_ROOT
    / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1"
    / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.json"
)
BACKLOG_POST_CHECK_CANDIDATES = [
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check"
        / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_post_commit_check"
        / "repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
]

REQUIRED_BACKLOG_STATUS = "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
REQUIRED_BACKLOG_POST_CHECK_STATUS = "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS"
REQUIRED_BACKLOG_NEXT_ACTION = "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
REQUIRED_BACKLOG_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
REQUIRED_BACKLOG_FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BACKLOG_READY_FOR_NEXT_ACTION_SELECTOR"

READY_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
BLOCKED_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED"
FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_EVALUATED_READY_FOR_DEVELOPMENT_QUEUE_SELECTOR"
NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": True,
    "next_action_selector_only": True,
    "read_only_backlog_evidence_validation_only": True,
    "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_allowed_next": True,
...
def physical_guard_snapshot() -> Dict[str, Any]:
    ...
    snapshot: Dict[str, Any] = {
        ...
        "target_file": CURRENT_TOOL_REL,
        "target_file_exists_now": (REPO_ROOT / CURRENT_TOOL_REL).exists(),
    }
...
def backlog_route_object(backlog_obj: Dict[str, Any]) -> Dict[str, Any]:
    route = backlog_obj.get(
        "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh",
        {},
    )
...
def validate_backlog_record(errors: List[str], backlog_obj: Dict[str, Any]) -> None:
    status_key = "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status"
    if backlog_obj.get(status_key) != REQUIRED_BACKLOG_STATUS:
        errors.append(f"development backlog refresh status mismatch: {backlog_obj.get(status_key)}")
    ...
    if backlog_obj.get("final_decision") != REQUIRED_BACKLOG_FINAL_DECISION:
        errors.append(f"development backlog refresh final_decision mismatch: {backlog_obj.get('final_decision')}")
    if not derived_live_repo_continuity_recorded(backlog_obj):
        errors.append("development backlog refresh derived_live_repo_post_check continuity invalid")
...
def validate_backlog_route(errors: List[str], backlog_obj: Dict[str, Any]) -> None:
    ...
    if not isinstance(selected, dict):
        ...
        return
    if selected.get("key") != "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH":
    ...
    if selected.get("scope") != "REPO_ONLY_OS_INTELLIGENCE":
        errors.append(f"development backlog refresh selected scope mismatch: {selected.get('scope')}")
    ...
    if not isinstance(prerequisites, dict) or not prerequisites or not all(value is True for value in prerequisites.values()):
        errors.append(f"development backlog refresh prerequisites not all true: {prerequisites}")
    ...
    if not isinstance(invariants, dict) or not invariants or not all(value is True for value in invariants.values()):
        errors.append(f"development backlog refresh invariants not all true: {invariants}")
...
def derive_live_repo_post_check(
    ...
    replacement_checks = {
        ...
        "latest_commit_path_is_prior_development_backlog_refresh_module": latest_commit_paths == [PRIOR_COMMIT_REL],
        ...
        "backlog_refresh_json_ready": backlog_obj.get(status_key) == REQUIRED_BACKLOG_STATUS,
        "backlog_refresh_next_module_is_current_module": backlog_obj.get("next_module") == REQUIRED_BACKLOG_NEXT_MODULE,
        "backlog_refresh_derived_live_repo_post_check_recorded": derived_live_repo_continuity_recorded(backlog_obj),
    }
    errors = [key for key, passed in replacement_checks.items() if not passed]
    return {
        "audit_status": REQUIRED_BACKLOG_POST_CHECK_STATUS if not errors else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_FAIL",
        ...
        "derived_live_repo_post_check_reason": "Expected prior development backlog refresh post-check marker artifact was not present; live repo state and backlog refresh JSON were used as an explicit replacement check set.",
...
def load_or_derive_backlog_post_check(
    ...
    if artifact is not None:
        ...
        return obj
    return derive_live_repo_post_check(state, tracked_python, backlog_obj)
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if state["dirty_tracked_count"] != 0:
        errors.append(f"dirty tracked paths present before next-action selector run: {state['dirty_tracked_paths']}")
    if state["staged_count"] != 0:
        errors.append(f"staged paths present before next-action selector run: {state['staged_paths']}")
    if state["untracked_paths"] != [CURRENT_TOOL_REL]:
        errors.append(f"unexpected untracked paths before next-action selector run: expected={[CURRENT_TOOL_REL]} actual={state['untracked_paths']}")
    ...
    if physical_before["target_file_exists_now"] is not True:
        errors.append(f"approved target file missing during next-action selector run: {CURRENT_TOOL_REL}")
    if physical_before["planned_schema_file_existing_count"] != 0:
        errors.append(f"planned schema files existed before next-action selector run: {physical_before['existing_planned_schema_files']}")
    if physical_before["generic_runner_target_file_exists_now"] is not False:
        errors.append(f"generic runner target file existed before next-action selector run: {GENERIC_RUNNER_TARGET_FILE}")
    if tracked_python["tracked_python_file_count"] != EXPECTED_TRACKED_PYTHON_COUNT:
        errors.append(
            "tracked Python count mismatch before next-action selector commit: "
    ...
    try:
        ...
        errors.append(f"cannot load development backlog refresh: {BACKLOG_JSON} error={repr(exc)}")

    try:
        post_check = load_or_derive_backlog_post_check(state, tracked_python, backlog_obj)
        ...
        errors.append(f"cannot load or derive development backlog refresh post-check: {repr(exc)}")

    physical_after = physical_guard_snapshot()
    if physical_after["planned_schema_file_existing_count"] != 0:
        errors.append(f"planned schema files existed after next-action selector validation: {physical_after['existing_planned_schema_files']}")
    if physical_after["generic_runner_target_file_exists_now"] is not False:
        errors.append(f"generic runner target file existed after next-action selector validation: {GENERIC_RUNNER_TARGET_FILE}")
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "parent_backlog_refresh_ready": backlog_obj.get("development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status") == REQUIRED_BACKLOG_STATUS,
        ...
        "parent_selected_this_next_action_selector": selected_from_parent.get("module") == REQUIRED_BACKLOG_NEXT_MODULE,
        "parent_selected_next_action_selector_key": selected_from_parent.get("key") == "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
            "module": NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "The latest repo-only backlog refresh selected this next-action selector; route to the next repo-only development queue selector without unblocking generic runner work.",
            "blocked_actions": [
    ...
    return {
        "selector_status": "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ACTIVE" if selected else "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        "candidate_actions": candidate_actions,
        "candidate_action_count": len(candidate_actions),
        "allowed_candidate_action_count": sum(1 for item in candidate_actions if item["allowed"]),
        "blocked_candidate_action_count": sum(1 for item in candidate_actions if not item["allowed"]),
        "scope_counts": dict(Counter(item["scope"] for item in candidate_actions)),
        ...
        "confirmed_proofs": {
            ...
            "backlog_refresh_selected_repo_only_next_action_selector_route": selected_from_parent.get("key") == "NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "invariants": {
            ...
            "selected_module_is_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": selected is not None and selected["module"] == NEXT_MODULE,
            "selected_action_is_development_queue_selector": selected is not None and selected["key"] == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
...
def build_payload(validation: Dict[str, Any], selector: Dict[str, Any], errors: List[str]) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status": READY_STATUS if passed else BLOCKED_STATUS,
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": FINAL_DECISION if passed else "KEEP_GENERIC_GOVERNANCE_BLOCKED_REVIEW_NEXT_ACTION_SELECTOR_AFTER_BACKLOG_REFRESH_ERRORS",
        "next_action": NEXT_ACTION if passed else "REVIEW_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        "next_module": NEXT_MODULE if passed else None,
        "reason": (
            "Selected the next safe repo-only development queue selector after validating the latest generic governance blocked-status backlog refresh."
            if passed
        ...
        "counts": {
            ...
            "allowed_candidate_action_count": selector["allowed_candidate_action_count"],
            "blocked_candidate_action_count": selector["blocked_candidate_action_count"],
        },
        "validation": {
        ...
        "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": selector,
...
def write_outputs(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    latest_json = OUT_DIR / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_{stamp}.json"
    latest_txt = OUT_DIR / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.txt"
    ...
    lines = [
        "EDGE FACTORY OS REPO-ONLY NEXT ACTION SELECTOR AFTER GENERIC GOVERNANCE BLOCKED STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG REFRESH v1",
        "=" * 120,
        ...
        json.dumps(
            {
                "selected_action": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["selected_action"],
                "confirmed_proofs": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["confirmed_proofs"],
                "prerequisites": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["prerequisites"],
                "invariants": payload["next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["invariants"],
...
def main() -> int:
    ...
    if selector["selected_next_module"] not in (NEXT_MODULE, None):
        errors.append(f"unexpected selected next module: {selector['selected_next_module']}")
