...
MODULE_NAME = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME

EXPECTED_HEAD = "5f8f4f5"
EXPECTED_TRACKED_PYTHON_COUNT = 555
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
PRIOR_COMMIT_REL = "tools/edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
EXPECTED_HEAD_SUBJECT = "Add repo-only next action selector after generic governance blocked status backlog status backlog status backlog status backlog status backlog status backlog refresh"

PRIOR_SELECTOR_JSON = (
    LAB_ROOT
    / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1"
    / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.json"
)
PRIOR_POST_CHECK_CANDIDATES = [
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check"
        / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
    (
        LAB_ROOT
        / "edge_factory_os_repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_post_commit_check"
        / "repo_only_next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_post_commit_check_latest.json"
    ),
]

REQUIRED_PRIOR_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
REQUIRED_PRIOR_POST_CHECK_STATUS = "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS"
REQUIRED_PRIOR_NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
REQUIRED_PRIOR_NEXT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
REQUIRED_PRIOR_FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_EVALUATED_READY_FOR_DEVELOPMENT_QUEUE_SELECTOR"

READY_STATUS = "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_READY"
BLOCKED_STATUS = "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1_BLOCKED"
FINAL_DECISION = "GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_QUEUE_SELECTED_READY_FOR_BACKLOG_REFRESH"
NEXT_ACTION = "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_V1"
NEXT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": True,
    "development_queue_selector_only": True,
    "read_only_prior_selector_evidence_validation_only": True,
    "development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_allowed_next": True,
...
def prior_selector_route_object(prior_obj: Dict[str, Any]) -> Dict[str, Any]:
    route = prior_obj.get(
        "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh",
        {},
    )
...
def validate_prior_selector_record(errors: List[str], prior_obj: Dict[str, Any]) -> None:
    status_key = "next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status"
    ...
    if not derived_live_repo_continuity_recorded(prior_obj):
        errors.append("prior next-action selector derived_live_repo_post_check continuity invalid")
...
def validate_prior_selector_route(errors: List[str], prior_obj: Dict[str, Any]) -> None:
    ...
    if not isinstance(selected, dict):
        ...
        return
    if selected.get("key") != "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH":
    ...
    if selected.get("scope") != "REPO_ONLY_OS_INTELLIGENCE":
        errors.append(f"prior next-action selector selected scope mismatch: {selected.get('scope')}")
    ...
    if not isinstance(prerequisites, dict) or not prerequisites or not all(value is True for value in prerequisites.values()):
        errors.append(f"prior next-action selector prerequisites not all true: {prerequisites}")
    ...
    if not isinstance(invariants, dict) or not invariants or not all(value is True for value in invariants.values()):
        errors.append(f"prior next-action selector invariants not all true: {invariants}")
...
def derive_live_repo_post_check(state: Dict[str, Any], tracked_python: Dict[str, Any], prior_obj: Dict[str, Any]) -> Dict[str, Any]:
    ...
    replacement_checks = {
        ...
        "prior_selector_derived_live_repo_post_check_recorded": derived_live_repo_continuity_recorded(prior_obj),
    }
    errors = [key for key, passed in replacement_checks.items() if not passed]
    return {
        "audit_status": REQUIRED_PRIOR_POST_CHECK_STATUS if not errors else "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_POST_COMMIT_CHECK_FAIL",
        ...
        "derived_live_repo_post_check_reason": "Expected prior next-action selector post-check marker artifact was not present; live repo state and prior selector JSON were used as an explicit replacement check set.",
...
def load_or_derive_prior_post_check(state: Dict[str, Any], tracked_python: Dict[str, Any], prior_obj: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if artifact is not None:
        ...
        return obj
    return derive_live_repo_post_check(state, tracked_python, prior_obj)
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if state["dirty_tracked_count"] != 0:
        errors.append(f"dirty tracked paths present before queue selector run: {state['dirty_tracked_paths']}")
    if state["staged_count"] != 0:
        errors.append(f"staged paths present before queue selector run: {state['staged_paths']}")
    if state["untracked_paths"] != [CURRENT_TOOL_REL]:
        errors.append(f"unexpected untracked paths before queue selector run: expected={[CURRENT_TOOL_REL]} actual={state['untracked_paths']}")
    ...
    if physical_before["target_file_exists_now"] is not True:
        errors.append(f"approved target file missing during queue selector run: {CURRENT_TOOL_REL}")
    ...
    try:
        ...
        errors.append(f"cannot load prior next-action selector: {PRIOR_SELECTOR_JSON} error={repr(exc)}")

    try:
        post_check = load_or_derive_prior_post_check(state, tracked_python, prior_obj)
        loaded["prior_next_action_selector_post_check"] = post_check
        source_statuses["prior_next_action_selector_post_check"] = source_record(Path(post_check.get("post_check_artifact_path", "<derived-live-repo-post-check>")), post_check)
...
def build_selector(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "parent_next_action_selector_ready": prior_obj.get("next_action_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status") == REQUIRED_PRIOR_STATUS,
        "parent_post_check_pass": post_check.get("audit_status") == REQUIRED_PRIOR_POST_CHECK_STATUS,
        "parent_post_check_head_current": post_check.get("latest_commit") == EXPECTED_HEAD,
        "parent_selected_this_queue_selector": selected_from_parent.get("module") == REQUIRED_PRIOR_NEXT_MODULE,
        "parent_selected_queue_selector_key": selected_from_parent.get("key") == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "implementation_remains_blocked": proofs.get("generic_governance_runner_implementation_remains_blocked") is True and prior_obj.get("implementation_allowed_now") is False,
        "manual_approval_remains_absent": proofs.get("manual_approval_remains_absent") is True and prior_obj.get("manual_approval_present_now") is False,
        "manual_approval_remains_invalid": proofs.get("manual_approval_remains_invalid") is True and prior_obj.get("manual_approval_valid_now") is False,
        ...
        "prior_derived_live_repo_post_check_continuity_recorded": derived_live_repo_continuity_recorded(prior_obj)
        and (
    ...
    candidate_actions = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
            "module": NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "The prior next-action selector routed here and all generic runner, config, schema, apply, runtime, research, and capital paths remain blocked.",
            "blocked_actions": [
    ...
    return {
        "selector_status": "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_BLOCKED",
        ...
        "confirmed_proofs": {
            ...
            "next_action_selector_selected_repo_only_development_queue_selector_route": selected_from_parent.get("key") == "DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
        ...
        "invariants": {
            ...
            "selected_module_is_development_backlog_refresh_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": selected is not None and selected["module"] == NEXT_MODULE,
            "selected_action_is_development_backlog_refresh": selected is not None and selected["key"] == "DEVELOPMENT_BACKLOG_REFRESH_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH",
...
def build_payload(validation: Dict[str, Any], selector: Dict[str, Any], errors: List[str]) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_status": READY_STATUS if passed else BLOCKED_STATUS,
        ...
        "next_action": NEXT_ACTION if passed else "REVIEW_DEVELOPMENT_QUEUE_SELECTOR_AFTER_GENERIC_GOVERNANCE_BLOCKED_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_STATUS_BACKLOG_REFRESH_ERRORS",
        "next_module": NEXT_MODULE if passed else None,
        "reason": (
            "Selected the next safe repo-only development backlog refresh after validating the latest next-action selector."
            if passed
        ...
        "development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh": selector,
...
def write_outputs(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    latest_json = OUT_DIR / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_{stamp}.json"
    latest_txt = OUT_DIR / "repo_only_development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh_v1_latest.txt"
    ...
    lines = [
        "EDGE FACTORY OS REPO-ONLY DEVELOPMENT QUEUE SELECTOR AFTER GENERIC GOVERNANCE BLOCKED STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG STATUS BACKLOG REFRESH v1",
        "=" * 120,
        ...
        json.dumps(
            {
                "selected_action": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["selected_action"],
                "confirmed_proofs": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["confirmed_proofs"],
                "prerequisites": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["prerequisites"],
                "invariants": payload["development_queue_selector_after_generic_governance_blocked_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_status_backlog_refresh"]["invariants"],
