...
EVALUATOR_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_beta_neutral_residual_mr_evaluator_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_closures" / "crypto_15m_beta_neutral_residual_mr_closure_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_CLOSURE_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_CLOSURE"
...
EVALUATOR_STATUS = "PASS_REPO_ONLY_CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_EVALUATED"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_beta_neutral_residual_mr_closure_v1.py",
        "?? artifacts/strategy_closures/crypto_15m_beta_neutral_residual_mr_closure_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_beta_neutral_residual_mr_closure_v1",
        "strategy": STRATEGY,
        ...
        "closure_result": {
            ...
            "closure_note": "Single-config BTC/ETH beta-neutral residual mean-reversion diagnostic closed with evaluator result preserved. No candidate, edge, runtime, live, or capital permission is created.",
        },
        "final_metric_snapshot": {
            "accepted_long_residual_trades": metric_summary.get("accepted_long_residual_trades"),
            "accepted_short_residual_trades": metric_summary.get("accepted_short_residual_trades"),
            ...
            "symbol_leg_pnl_usdt": metric_summary.get("symbol_leg_pnl_usdt"),
            "btc_hedge_pnl_usdt": metric_summary.get("btc_hedge_pnl_usdt"),
            "eth_hedge_pnl_usdt": metric_summary.get("eth_hedge_pnl_usdt"),
            "total_cost_pnl_usdt": metric_summary.get("total_cost_pnl_usdt"),
