...
ARTIFACT_PATH = (
    ...
    / "artifacts"
    / "strategy_closures"
    / "crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_closure_v1.json"
)

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_CLOSURE_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_SHORT_ONLY_V3_STOP_RISK_CLOSURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_closure_v1.py",
        "?? artifacts/strategy_closures/crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_closure_v1.json",
    }
    ...
    checks = {
        ...
        "config_id_verified": evaluator.get("config_id") == CONFIG_ID,
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_short_only_v3_stop_risk_closure_v1",
        "strategy": STRATEGY,
        ...
        "closure_result": {
            ...
            "closure_note": "Short-only V3 stop-risk diagnostic closed with evaluator result preserved. No candidate, edge, runtime, live, or capital permission is created.",
        },
        "final_metric_snapshot": {
            "disabled_long_candidate_count": metric_summary.get("disabled_long_candidate_count"),
            "stop_risk_quality_blocked": metric_summary.get("stop_risk_quality_blocked"),
            "stop_risk_quality_gate_passed": metric_summary.get("stop_risk_quality_gate_passed"),
            ...
            "stop_exit_count": metric_summary.get("stop_exit_count"),
            "take_profit_exit_count": metric_summary.get("take_profit_exit_count"),
            "time_stop_exit_count": metric_summary.get("time_stop_exit_count"),
            "top_symbol_concentration": metric_summary.get("top_symbol_concentration"),
            "null_baseline": metric_summary.get("null_baseline"),
            "v2_comparison_deltas": metric_summary.get("v2_comparison_deltas"),
