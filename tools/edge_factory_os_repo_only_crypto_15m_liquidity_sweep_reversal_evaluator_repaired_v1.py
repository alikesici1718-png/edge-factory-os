...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_liquidity_sweep_reversal_execution_repaired_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_liquidity_sweep_reversal_evaluator_repaired_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_EXECUTED"

PROMISING = "CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_LIQUIDITY_SWEEP_REVERSAL_REPAIRED_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_liquidity_sweep_reversal_evaluator_repaired_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_liquidity_sweep_reversal_evaluator_repaired_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_liquidity_sweep_reversal_evaluator_repaired_v1",
        "strategy": STRATEGY,
        ...
        "execution_metric_summary": {
            ...
            "raw_long_sweep_count": metrics.get("raw_long_sweep_count"),
            "raw_short_sweep_count": metrics.get("raw_short_sweep_count"),
            "final_long_candidate_count": metrics.get("final_long_candidate_count"),
            "final_short_candidate_count": metrics.get("final_short_candidate_count"),
            ...
            "exit_counts": {
                ...
                "time": metrics.get("time_stop_exit_count"),
            },
