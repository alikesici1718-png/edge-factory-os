...
MODULE_NAME = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "d15ca2f"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh": True,
    "read_only_development_queue_selection_only": True,
    "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_required": True,
    "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_allowed_next": True,
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only next-action selector after standard OS status backlog status backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py"]:
    ...
    if py["tracked_python_file_count"] != 512:
        errors.append(f"tracked Python count mismatch: expected=512 actual={py['tracked_python_file_count']}")
...
def build_queue(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    selected_backlog_item = backlog.get("selected_next_backlog_item", {}) if isinstance(backlog, dict) else {}
    ...
    prerequisites = {
        ...
        "selector_post_check_pass": validation["source_statuses"].get("next_action_selector_post_check", {}).get("status") == "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
        ...
        "backlog_selected_selector": selected_backlog_item.get("module") == "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1.py",
    ...
    queue_items = [
        {
            "rank": 1,
            "key": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH",
    ...
    return {
        "development_queue_status": "DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        ...
        "context_summary": {
            ...
            "backlog_selected_module": selected_backlog_item.get("module"),
        ...
        "invariants": {
            ...
            "selected_module_is_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_QUEUE_SELECTED_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_DEVELOPMENT_QUEUE_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Selected repo-only development backlog refresh after standard OS status backlog status backlog backlog refresh; schema apply/create/edit remain blocked and physically absent." if passed else "Development queue selector after standard OS status backlog status backlog backlog refresh validation failed.",
        ...
        "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh": queue,
    ...
    latest_json = OUT_DIR / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1_latest.txt"
    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY DEVELOPMENT QUEUE SELECTOR AFTER STANDARD OS STATUS BACKLOG STATUS BACKLOG BACKLOG REFRESH v1",
        "=" * 100,
        f"status: {payload['development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_refresh_status']}",
