...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_trap_score4_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_idiosyncratic_sweep_short_trap_score4_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_EXECUTED"

PROMISING = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_score4_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_idiosyncratic_sweep_short_trap_score4_evaluator_v1.json",
    }
    ...
    if metrics.get("trap_quality_score_rule") != "score == 4":
        invalidated_reasons.append("trap_quality_score_rule_not_score4")
    ...
    checks = {
        ...
        "trap_quality_score_rule_verified": metrics.get("trap_quality_score_rule") == "score == 4",
        "trap_quality_score_4_metric_present": metrics.get("trap_quality_score_4_count") is not None,
        "trap_score4_block_metric_present": metrics.get("trap_score4_blocked") is not None,
    ...
    artifact = {
        ...
        "execution_metric_summary": {
            "trap_quality_score_4_count": metrics.get("trap_quality_score_4_count"),
            "trap_score4_blocked": metrics.get("trap_score4_blocked"),
