...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_beta_neutral_residual_mr_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_beta_neutral_residual_mr_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_EXECUTED"

PROMISING = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_BETA_NEUTRAL_RESIDUAL_MR_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_beta_neutral_residual_mr_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_beta_neutral_residual_mr_evaluator_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_beta_neutral_residual_mr_evaluator_v1",
        "strategy": STRATEGY,
        ...
        "execution_metric_summary": {
            "accepted_long_residual_trades": metrics.get("accepted_long_residual_trades"),
            "accepted_short_residual_trades": metrics.get("accepted_short_residual_trades"),
            "closed_trades": metrics.get("closed_trades"),
            "validation_closed_trades": metrics.get("validation_closed_trades"),
            "holdout_closed_trades": metrics.get("holdout_closed_trades"),
            ...
            "symbol_leg_pnl_usdt": metrics.get("symbol_leg_pnl_usdt"),
            "btc_hedge_pnl_usdt": metrics.get("btc_hedge_pnl_usdt"),
            "eth_hedge_pnl_usdt": metrics.get("eth_hedge_pnl_usdt"),
            "total_cost_pnl_usdt": metrics.get("total_cost_pnl_usdt"),
