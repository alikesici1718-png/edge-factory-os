...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_closures" / "crypto_15m_residual_sweep_confirmation_closure_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_CLOSURE_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_RESIDUAL_SWEEP_CONFIRMATION_CLOSURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_closure_v1.py",
        "?? artifacts/strategy_closures/crypto_15m_residual_sweep_confirmation_closure_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_residual_sweep_confirmation_closure_v1",
        "strategy": STRATEGY,
        ...
        "closure_result": {
            ...
            "closure_note": "Single-config residual sweep confirmation diagnostic closed with evaluator result preserved. No candidate, edge, runtime, live, or capital permission is created.",
        },
