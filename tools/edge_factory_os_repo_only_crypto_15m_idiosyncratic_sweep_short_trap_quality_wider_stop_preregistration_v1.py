...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_preregistration_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_WIDER_STOP_PREREGISTRATION_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_QUALITY_WIDER_STOP_PREREGISTRATION"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_preregistration_v1.py",
        "?? artifacts/research_preregistrations/crypto_15m_idiosyncratic_sweep_short_trap_quality_wider_stop_preregistration_v1.json",
    }
    ...
    only_changed_parameter = {
        ...
        "prior_value": 0.5,
        "new_value": 1.0,
        "interpretation": "Use a wider structural stop while keeping fixed 5 USDT risk, which may reduce notional instead of increasing dollar risk.",
        "structural_exit_risk_repair": True,
    ...
    artifact = {
        ...
        "preregistered_config": {
            ...
            "strategy_change_summary": "Inherited trap-quality short-only stack unchanged except short stop buffer widens from 0.5 ATR14 to 1.0 ATR14.",
