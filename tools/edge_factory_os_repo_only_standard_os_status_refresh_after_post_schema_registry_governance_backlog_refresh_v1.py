...
MODULE_NAME = "edge_factory_os_repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / "edge_factory_os_repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1"
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD_PREFIX = "c08b2d9"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1.py"
...
SELECTOR_JSON = LAB_ROOT / "edge_factory_os_repo_only_next_action_selector_after_post_schema_registry_governance_backlog_refresh_v1" / "repo_only_next_action_selector_after_post_schema_registry_governance_backlog_refresh_v1_latest.json"
SELECTOR_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_next_action_selector_after_post_schema_registry_governance_backlog_refresh_post_commit_check" / "repo_only_next_action_selector_after_post_schema_registry_governance_backlog_refresh_post_commit_check_latest.json"

SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_refresh_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh": True,
    "read_only_standard_status_refresh_only": True,
    "development_queue_selector_after_post_schema_registry_governance_backlog_refresh_required": True,
    "next_action_selector_after_standard_os_status_refresh_allowed_next": True,
...
def first_status(obj: Dict[str, Any]) -> Optional[str]:
    for key in [
        ...
        "audit_status",
        "next_action_selector_after_post_schema_registry_governance_backlog_refresh_status",
    ]:
        value = obj.get(key)
        if value:
            return str(value)
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development queue selector after post schema registry governance backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")

    paths = commit_paths("HEAD")
    checks["head_commit_paths"] = paths
    if paths != ["tools/edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_governance_backlog_refresh_v1.py"]:
    ...
    inputs = {
        "development_queue_selector": (
            ...
            "edge_factory_os_repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1.py",
        ),
        ...
        "next_action_selector_after_governance_backlog_refresh": (
            SELECTOR_JSON,
            "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_V1_READY",
            None,
        ),
        "next_action_selector_after_governance_backlog_refresh_post_check": (
            SELECTOR_POST_JSON,
            "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
            None,
        ),
    }
...
def build_status_refresh(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    selector_obj = validation["loaded"]["next_action_selector_after_governance_backlog_refresh"]
    selector = selector_obj.get("next_action_selector_after_post_schema_registry_governance_backlog_refresh", {})
    ...
    prerequisites = {
        ...
        "queue_selected_this_refresh": selected_task.get("module") == "edge_factory_os_repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1.py",
        "queue_selected_repo_only_scope": selected_task.get("scope") == "REPO_ONLY_OS_INTELLIGENCE",
        "selector_ready": selector_obj.get("next_action_selector_after_post_schema_registry_governance_backlog_refresh_status") == "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_V1_READY",
        "selector_selected_queue": selected_action.get("module") == "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_governance_backlog_refresh_v1.py",
    ...
    return {
        "standard_status_refresh_status": "STANDARD_OS_STATUS_REFRESH_AFTER_GOVERNANCE_BACKLOG_READY" if all(prerequisites.values()) else "STANDARD_OS_STATUS_REFRESH_AFTER_GOVERNANCE_BACKLOG_BLOCKED",
        "standard_os_status": standard_status,
        "selected_next_step": {
            "step": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_REFRESH_V1",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "reason": "Standard OS status refreshed after governance backlog queue selector; select next repo-only task.",
        },
        "context_summary": {
        ...
        "invariants": {
            ...
            "selected_next_module_is_next_action_selector": SELECTED_NEXT_MODULE == "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_refresh_v1.py",
...
def main() -> int:
    ...
    payload = {
        "module": MODULE_NAME,
        "standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_status": "REPO_ONLY_STANDARD_OS_STATUS_REFRESH_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_STANDARD_OS_STATUS_REFRESH_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "STANDARD_OS_STATUS_REFRESH_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_READY_FOR_NEXT_ACTION_SELECTOR" if passed else "KEEP_FREEZE_REVIEW_STANDARD_OS_STATUS_REFRESH_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_REFRESH_V1" if passed else "REVIEW_STANDARD_OS_STATUS_REFRESH_AFTER_POST_SCHEMA_REGISTRY_GOVERNANCE_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Standard OS status refreshed after governance backlog; schema apply/create/edit remain blocked and physically absent." if passed else "Standard OS status refresh after governance backlog validation failed.",
        ...
        "standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh": refresh,
    ...
    latest_json = OUT_DIR / "repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_v1_latest.txt"

    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY STANDARD OS STATUS REFRESH AFTER POST-SCHEMA-REGISTRY GOVERNANCE BACKLOG REFRESH v1",
        "=" * 100,
        f"standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_status: {payload['standard_os_status_refresh_after_post_schema_registry_governance_backlog_refresh_status']}",
