...
MODULE_PATH = "tools/edge_factory_os_repo_only_lucifer_15m_v3_horizontal_cross_execution_v1.py"
...
def build_execution() -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "next_module": "tools/edge_factory_os_repo_only_lucifer_15m_v3_horizontal_cross_evaluator_v1.py",
        "validation_checks": {
