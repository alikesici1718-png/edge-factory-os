...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_preregistration_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_PREREGISTRATION_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_PREREGISTRATION"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_preregistration_v1.py",
        "?? artifacts/research_preregistrations/crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_preregistration_v1.json",
    }
    ...
    only_changed_parameter = {
        ...
        "prior_value": "trap_quality_score >= 3 allowed the rejection-depth component to fail if the other three components passed",
        "new_value": "trap_quality_score >= 3 and rejection_depth_atr >= 0.05",
        "interpretation": "Require the strongest trap-quality component while leaving the overall trap score, stop, risk-quality, confirmation, market veto, cost, and position rules unchanged.",
        "structural_event_quality_rule": True,
    ...
    trap_quality_filter = {
        ...
        "minimum_score": 3,
        "mandatory_component": "rejection_depth_atr >= 0.05",
    ...
    artifact = {
        ...
        "postmortem_and_recent_route_context": {
            ...
            "wider_stop_holdout_net_bps": wider_stop_execution.get("split_metrics", {}).get("holdout", {}).get("portfolio_net_bps"),
        ...
        "preregistered_config": {
            ...
            "strategy_change_summary": "Inherited trap-quality short-only stack unchanged except rejection_depth_atr >= 0.05 is mandatory.",
    ...
    print("rejection_depth_atr_required: true")
