...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_market_pump_veto_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_idiosyncratic_sweep_short_market_pump_veto_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_EXECUTED"

PROMISING = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_MARKET_PUMP_VETO_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_market_pump_veto_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_idiosyncratic_sweep_short_market_pump_veto_evaluator_v1.json",
    }
    ...
    checks = {
        ...
        "market_pump_veto_metric_present": metrics.get("market_pump_veto_blocked") is not None,
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_market_pump_veto_evaluator_v1",
        "strategy": STRATEGY,
        ...
        "execution_metric_summary": {
            ...
            "null_baseline": null,
            "v3_comparison_deltas": execution.get("v3_comparison_deltas"),
        },
