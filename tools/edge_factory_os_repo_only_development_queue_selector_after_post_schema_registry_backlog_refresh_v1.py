...
MODULE_NAME = "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1"
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD_PREFIX = "b19072f"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1.py"
...
SELECTOR_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_next_action_selector_after_post_schema_registry_backlog_refresh_post_commit_check" / "repo_only_next_action_selector_after_post_schema_registry_backlog_refresh_post_commit_check_latest.json"
...
BACKLOG_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_post_schema_registry_status_post_commit_check" / "repo_only_development_backlog_refresh_after_post_schema_registry_status_post_commit_check_latest.json"
QUEUE_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_status_v1" / "repo_only_development_queue_selector_after_post_schema_registry_status_v1_latest.json"
...
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_schema_registry_governance_chain_closure_record_v1.py"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh": True,
    "read_only_development_queue_selection_only": True,
    "next_action_selector_after_post_schema_registry_backlog_refresh_required": True,
    "schema_registry_governance_chain_closure_record_allowed_next": True,
...
def first_status(obj: Dict[str, Any]) -> Optional[str]:
    for key in [
        ...
        "development_queue_selector_after_post_schema_registry_status_status",
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only next-action selector after post-schema-registry backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")

    paths = commit_paths("HEAD")
    checks["head_commit_paths"] = paths
    if paths != ["tools/edge_factory_os_repo_only_next_action_selector_after_post_schema_registry_backlog_refresh_v1.py"]:
    ...
    inputs = {
        "next_action_selector_after_backlog": (
            ...
            "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1.py",
        ),
        "next_action_selector_after_backlog_post_check": (
            SELECTOR_POST_JSON,
            "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
            "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1.py",
        ),
        ...
        "development_backlog_refresh_post_check": (
            BACKLOG_POST_JSON,
            "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_POST_SCHEMA_REGISTRY_STATUS_POST_COMMIT_CHECK_PASS",
            None,
        ),
        "development_queue_selector_after_status": (
            QUEUE_JSON,
            "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_STATUS_V1_READY",
            None,
        ),
...
def build_queue(validation: Dict[str, Any]) -> Dict[str, Any]:
    selector_obj = validation["loaded"]["next_action_selector_after_backlog"]
    selector = as_dict(selector_obj.get("next_action_selector_after_post_schema_registry_backlog_refresh", {}))
    selected_action = as_dict(selector.get("selected_action", {}))
    selector_context = as_dict(selector.get("context_summary", {}))

    backlog_obj = validation["loaded"]["development_backlog_refresh"]
    backlog = as_dict(backlog_obj.get("development_backlog_refresh_after_post_schema_registry_status", {}))
    selected_backlog_item = as_dict(backlog.get("selected_next_backlog_item", {}))
    backlog_context = as_dict(backlog.get("context_summary", {}))

    previous_queue_obj = validation["loaded"]["development_queue_selector_after_status"]
    previous_queue = as_dict(previous_queue_obj.get("development_queue_selector_after_post_schema_registry_status", {}))
    previous_queue_context = as_dict(previous_queue.get("context_summary", {}))
    ...
    effective_approval_state = {
        "manual_approval_present": first_not_none(
            ...
            previous_queue_context.get("manual_approval_present"),
        ...
        "manual_approval_valid": first_not_none(
            ...
            previous_queue_context.get("manual_approval_valid"),
        ...
        "approval_granted_now": first_not_none(
            ...
            previous_queue_context.get("approval_granted_now"),
    ...
    effective_schema_state = {
        "schema_apply_allowed_now": first_not_none(
            ...
            previous_queue_context.get("schema_apply_allowed_now"),
        ...
        "schema_file_creation_allowed_now": first_not_none(
            ...
            previous_queue_context.get("schema_file_creation_allowed_now"),
        ...
        "schema_file_edit_allowed_now": first_not_none(
            ...
            previous_queue_context.get("schema_file_edit_allowed_now"),
    ...
    prerequisites = {
        "parent_selector_ready": selector_obj.get("next_action_selector_after_post_schema_registry_backlog_refresh_status") == "REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_V1_READY",
        "parent_selected_this_queue_selector": selected_action.get("module") == "edge_factory_os_repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1.py",
        "parent_selected_repo_only_scope": selected_action.get("scope") == "REPO_ONLY_OS_INTELLIGENCE",
        "backlog_ready": backlog_obj.get("development_backlog_refresh_after_post_schema_registry_status_status") == "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_POST_SCHEMA_REGISTRY_STATUS_V1_READY",
        "backlog_selected_parent_selector": selected_backlog_item.get("module") == "edge_factory_os_repo_only_next_action_selector_after_post_schema_registry_backlog_refresh_v1.py",
    ...
    queue_items = [
        {
            "rank": 1,
            "key": "SCHEMA_REGISTRY_GOVERNANCE_CHAIN_CLOSURE_RECORD",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "The schema-registry governance loop is safely blocked at manual approval; record closure and return to general repo-only governance flow.",
            "blocked_actions": [
    ...
    return {
        "development_queue_status": "DEVELOPMENT_QUEUE_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_QUEUE_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_SCHEMA_REGISTRY_GOVERNANCE_CHAIN_CLOSURE_RECORD_V1" if selected else None,
        ...
        "context_summary": {
            ...
            "approval_state_source_order": "status_summary.approval_state -> status_summary flat -> parent selector context -> backlog context -> previous queue context -> manual approval record",
            "schema_state_source_order": "status_summary.schema_action_state -> status_summary flat -> parent selector context -> backlog context -> previous queue context -> manual approval record",
            ...
            "previous_queue_context": previous_queue_context,
        },
        "physical_guards": {
        ...
        "queue_policy": {
            ...
            "schema_registry_governance_chain_closure_record_selected": True,
        ...
        "invariants": {
            ...
            "selected_module_is_schema_registry_governance_chain_closure_record": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload = {
        "module": MODULE_NAME,
        "development_queue_selector_after_post_schema_registry_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_QUEUE_SELECTED_SCHEMA_REGISTRY_GOVERNANCE_CHAIN_CLOSURE_RECORD" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_QUEUE_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_SCHEMA_REGISTRY_GOVERNANCE_CHAIN_CLOSURE_RECORD_V1" if passed else "REVIEW_DEVELOPMENT_QUEUE_AFTER_POST_SCHEMA_REGISTRY_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Selected repo-only schema-registry governance chain closure record; schema apply/create/edit remain blocked and physically absent." if passed else "Development queue selector after post-schema-registry backlog refresh validation failed.",
        ...
        "development_queue_selector_after_post_schema_registry_backlog_refresh": queue,
    ...
    latest_json = OUT_DIR / "repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_queue_selector_after_post_schema_registry_backlog_refresh_v1_latest.txt"

    latest_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")
    timestamped_json.write_text(json.dumps(payload, indent=2, sort_keys=True), encoding="utf-8")

    lines = [
        "EDGE FACTORY OS REPO-ONLY DEVELOPMENT QUEUE SELECTOR AFTER POST-SCHEMA-REGISTRY BACKLOG REFRESH v1",
        "=" * 100,
        f"development_queue_selector_after_post_schema_registry_backlog_refresh_status: {payload['development_queue_selector_after_post_schema_registry_backlog_refresh_status']}",
