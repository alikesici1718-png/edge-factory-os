...
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "research_preregistrations" / "crypto_15m_idiosyncratic_sweep_short_trap_score4_preregistration_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_PREREGISTRATION_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_TRAP_SCORE4_PREREGISTRATION"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_trap_score4_preregistration_v1.py",
        "?? artifacts/research_preregistrations/crypto_15m_idiosyncratic_sweep_short_trap_score4_preregistration_v1.json",
    }
    ...
    only_changed_parameter = {
        "field": "trap_quality_score_rule",
        "prior_value": "trap_quality_score >= 3",
        "new_value": "trap_quality_score == 4",
        "interpretation": "Only take setups where all four already-defined trap-quality components pass.",
        "natural_structural_boundary": True,
    ...
    validation_checks = {
        ...
        "only_trap_quality_score_rule_changed": True,
    ...
    artifact = {
        ...
        "preregistered_config": {
            ...
            "strategy_change_summary": "Inherited trap-quality short-only stack unchanged except trap_quality_score must equal 4.",
    ...
    print("trap_quality_score_rule: score == 4")
