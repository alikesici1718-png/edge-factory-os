...
MODULE_NAME = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1"
OUT_DIR = LAB_ROOT / MODULE_NAME
OUT_DIR.mkdir(parents=True, exist_ok=True)

EXPECTED_HEAD = "b7f2bc5"
CURRENT_TOOL_REL = "tools/edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"
APPROVED_CURRENT_MODULE = "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"
SELECTED_NEXT_MODULE = "edge_factory_os_repo_only_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_v1.py"
...
PRIOR_BACKLOG_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1_latest.json"
PRIOR_BACKLOG_POST_JSON = LAB_ROOT / "edge_factory_os_repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_v1_post_commit_check" / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_refresh_post_commit_check_latest.json"
...
SAFETY_FLAGS: Dict[str, bool] = {
    "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh": True,
    "read_only_backlog_refresh_only": True,
    "development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_required": True,
    "next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh_allowed_next": True,
...
INPUTS: Dict[str, Tuple[Path, str, Optional[str]]] = {
    ...
    "next_action_selector": (
        ...
        "edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py",
    ),
...
def validate_inputs() -> Dict[str, Any]:
    ...
    if subject != "Add repo-only development queue selector after standard OS status backlog status backlog backlog backlog refresh":
        errors.append(f"unexpected HEAD commit subject: {subject}")
    if paths != ["tools/edge_factory_os_repo_only_development_queue_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1.py"]:
    ...
    if py["tracked_python_file_count"] != 516:
        errors.append(f"tracked Python count mismatch: expected=516 actual={py['tracked_python_file_count']}")
...
def build_backlog(validation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prerequisites = {
        ...
        "queue_post_check_pass": validation["source_statuses"].get("development_queue_selector_post_check", {}).get("status") == "REPO_ONLY_DEVELOPMENT_QUEUE_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_POST_COMMIT_CHECK_PASS",
    ...
    backlog_items = [
        {
            "rank": 1,
            "key": "NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH",
            "module": SELECTED_NEXT_MODULE,
            "scope": "REPO_ONLY_OS_INTELLIGENCE",
            "allowed": True,
            "reason": "Backlog refreshed after standard OS status backlog status backlog backlog backlog refresh; select next repo-only action selector.",
            "blocked_actions": [
    ...
    return {
        "development_backlog_status": "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ACTIVE" if selected else "DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_BLOCKED",
        ...
        "selected_next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if selected else None,
        ...
        "invariants": {
            ...
            "selected_module_is_next_action_selector_after_standard_os_status_backlog_status_backlog_backlog_backlog_backlog_refresh": selected is not None and selected["module"] == SELECTED_NEXT_MODULE,
...
def main() -> int:
    ...
    payload: Dict[str, Any] = {
        "module": MODULE_NAME,
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_status": "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_READY" if passed else "REPO_ONLY_DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1_BLOCKED",
        "severity": "OK" if passed else "BLOCKED",
        "allowed_scope": "REPO_ONLY_OS_INTELLIGENCE",
        "final_decision": "DEVELOPMENT_BACKLOG_REFRESH_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_READY_FOR_NEXT_ACTION_SELECTOR" if passed else "KEEP_FREEZE_REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_action": "BUILD_REPO_ONLY_NEXT_ACTION_SELECTOR_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_BACKLOG_REFRESH_V1" if passed else "REVIEW_DEVELOPMENT_BACKLOG_AFTER_STANDARD_OS_STATUS_BACKLOG_STATUS_BACKLOG_BACKLOG_BACKLOG_REFRESH_ERRORS",
        "next_module": SELECTED_NEXT_MODULE if passed else None,
        "reason": "Development backlog refreshed after standard OS status backlog status backlog backlog backlog refresh; schema apply/create/edit remain blocked and physically absent." if passed else "Development backlog refresh after standard OS status backlog status backlog backlog backlog refresh validation failed.",
        ...
        "development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh": backlog,
    ...
    latest_json = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.json"
    timestamped_json = OUT_DIR / f"repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.json"
    latest_txt = OUT_DIR / "repo_only_development_backlog_refresh_after_standard_os_status_backlog_status_backlog_backlog_backlog_refresh_v1_latest.txt"
