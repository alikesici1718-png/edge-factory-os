...
EXECUTION_PATH = REPO_ROOT / "artifacts" / "strategy_executions" / "crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_execution_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_evaluator_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_EVALUATED"
ARTIFACT_KIND = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_EVALUATION"
...
EXECUTION_STATUS = "PASS_REPO_CODE_ONLY_CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_EXECUTED"

PROMISING = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_DIAGNOSTIC_PROMISING_NO_EDGE_NO_LIVE"
REJECTED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_REJECTED_NO_FOLLOWUP"
INCONCLUSIVE = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_INCONCLUSIVE_NEEDS_MORE_DATA"
INVALIDATED = "CRYPTO_15M_IDIOSYNCRATIC_SWEEP_SHORT_REJECTION_DEPTH_REQUIRED_INVALIDATED_BY_DATA_OR_INTEGRITY_FAILURE"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_evaluator_v1.py",
        "?? artifacts/strategy_evaluations/crypto_15m_idiosyncratic_sweep_short_rejection_depth_required_evaluator_v1.json",
    }
    ...
    if metrics.get("rejection_depth_required_passed") is None or metrics.get("rejection_depth_required_blocked") is None:
        invalidated_reasons.append("rejection_depth_required_metrics_missing")
    if execution.get("only_changed_parameter", {}).get("field") != "rejection_depth_atr_mandatory":
        invalidated_reasons.append("only_changed_parameter_not_rejection_depth")
    ...
    checks = {
        ...
        "trap_quality_score_rule_verified": integrity.get("checks", {}).get("trap_quality_score_min_3_unchanged") is True,
        "rejection_depth_required_metrics_present": metrics.get("rejection_depth_required_passed") is not None and metrics.get("rejection_depth_required_blocked") is not None,
        "only_changed_parameter_verified": execution.get("only_changed_parameter", {}).get("field") == "rejection_depth_atr_mandatory",
    ...
    artifact = {
        ...
        "execution_metric_summary": {
            "rejection_depth_required_passed": metrics.get("rejection_depth_required_passed"),
            "rejection_depth_required_blocked": metrics.get("rejection_depth_required_blocked"),
            ...
            "comparison_deltas_versus_wider_stop": execution.get("wider_stop_comparison_deltas"),
        },
