...
EVALUATOR_PATH = REPO_ROOT / "artifacts" / "strategy_evaluations" / "crypto_15m_regime_breakout_momentum_evaluator_v1.json"
ARTIFACT_PATH = REPO_ROOT / "artifacts" / "strategy_closures" / "crypto_15m_regime_breakout_momentum_closure_v1.json"

STATUS = "PASS_REPO_ONLY_CRYPTO_15M_REGIME_BREAKOUT_MOMENTUM_CLOSURE_CREATED"
ARTIFACT_KIND = "CRYPTO_15M_REGIME_BREAKOUT_MOMENTUM_CLOSURE"
...
EVALUATOR_STATUS = "PASS_REPO_ONLY_CRYPTO_15M_REGIME_BREAKOUT_MOMENTUM_EVALUATED"
...
def main() -> int:
    ...
    allowed_status = {
        "?? tools/edge_factory_os_repo_only_crypto_15m_regime_breakout_momentum_closure_v1.py",
        "?? artifacts/strategy_closures/crypto_15m_regime_breakout_momentum_closure_v1.json",
    }
    ...
    artifact = {
        ...
        "module": "edge_factory_os_repo_only_crypto_15m_regime_breakout_momentum_closure_v1",
        "strategy": STRATEGY,
        ...
        "closure_result": {
            ...
            "closure_note": "Single-config diagnostic cycle closed with evaluator result preserved. No candidate, edge, runtime, live, or capital permission is created.",
        },
        "final_metric_snapshot": {
            "bull_regime_timestamp_count": metric_summary.get("bull_regime_timestamp_count"),
            "bear_regime_timestamp_count": metric_summary.get("bear_regime_timestamp_count"),
            "neutral_timestamp_count": metric_summary.get("neutral_timestamp_count"),
