...
& $Python 'src\edge_factory_orderbook_um_81_full_bookdepth_download_validator_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: download_validator_exit_code=$ExitCode"
Write-Host "download_validator_json: outputs\orderbook_um_81_full_bookdepth_download_validator_report.json"
Write-Host "download_validator_md: outputs\orderbook_um_81_full_bookdepth_download_validator_report.md"
