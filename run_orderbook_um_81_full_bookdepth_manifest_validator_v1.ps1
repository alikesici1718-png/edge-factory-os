...
Write-Host "manifest_validation_json: outputs\orderbook_um_81_full_bookdepth_manifest_validation.json"
Write-Host "manifest_validation_md: outputs\orderbook_um_81_full_bookdepth_manifest_validation.md"
