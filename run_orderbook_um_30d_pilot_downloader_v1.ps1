...
& $Python "src\edge_factory_orderbook_um_30d_pilot_downloader_v1.py"
$ExitCode = $LASTEXITCODE

Write-Host "status: pilot_downloader_exit_code=$ExitCode"
Write-Host "download_summary: outputs\orderbook_um_30d_pilot_download_summary.json"
