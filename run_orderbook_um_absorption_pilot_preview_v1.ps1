...
& $Python 'src\edge_factory_orderbook_um_absorption_pilot_preview_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: absorption_pilot_preview_exit_code=$ExitCode"
Write-Host "summary: outputs\orderbook_um_absorption_pilot_preview_summary.json"
Write-Host "category_diagnostics: outputs\orderbook_um_absorption_pilot_category_diagnostics.csv"
Write-Host "sample: outputs\orderbook_um_absorption_pilot_sample.csv"
