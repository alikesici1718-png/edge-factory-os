...
& $Python 'src\edge_factory_orderbook_um_pilot_feature_validator_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: pilot_feature_validator_exit_code=$ExitCode"
Write-Host "validator_report: outputs\orderbook_um_pilot_feature_validator_report.json"
