...
& $Python "src\edge_factory_orderbook_um_30d_absorption_validator_v1.py"
$ExitCode = $LASTEXITCODE

Write-Host "status: absorption_validator_exit_code=$ExitCode"
Write-Host "validator_report: outputs\orderbook_um_30d_absorption_validator_report.json"
