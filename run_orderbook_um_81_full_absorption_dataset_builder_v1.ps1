...
& $Python 'src\edge_factory_orderbook_um_81_full_absorption_dataset_builder_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: absorption_dataset_builder_exit_code=$ExitCode"
Write-Host "build_summary_json: outputs\orderbook_um_81_full_absorption_dataset_build_summary.json"
Write-Host "build_summary_md: outputs\orderbook_um_81_full_absorption_dataset_build_summary.md"
Write-Host "partition_manifest_csv: outputs\orderbook_um_81_full_absorption_dataset_partition_manifest.csv"
Write-Host "output_root: $OutputFull"
Write-Host "full_build_env: ORDERBOOK_81_FULL_ABSORPTION_BUILD=$env:ORDERBOOK_81_FULL_ABSORPTION_BUILD"
Write-Host "lean_mode_env: ORDERBOOK_81_FULL_ABSORPTION_LEAN_MODE=$env:ORDERBOOK_81_FULL_ABSORPTION_LEAN_MODE"
