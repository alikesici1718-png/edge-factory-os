...
& $Python "src\edge_factory_orderbook_um_30d_strict_discovery_evaluator_v1.py"
$ExitCode = $LASTEXITCODE

Write-Host "status: strict_discovery_evaluator_exit_code=$ExitCode"
Write-Host "summary: outputs\orderbook_um_30d_strict_discovery_summary.json"
Write-Host "category_effects: outputs\orderbook_um_30d_strict_category_effects.csv"
Write-Host "candidate_hypotheses: outputs\orderbook_um_30d_strict_candidate_hypotheses.json"
