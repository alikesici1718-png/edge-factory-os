...
& $Python 'src\edge_factory_orderbook_um_absorption_pilot_validator_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: absorption_pilot_validator_exit_code=$ExitCode"
Write-Host "validator_report: outputs\orderbook_um_absorption_pilot_validator_report.json"
