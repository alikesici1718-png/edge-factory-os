"""
Gate-aware live paper logger for the session_short strategy family that polls OKX 1-minute
candles, checks the global gate decision before each entry, and logs simulated short trades to
the MASTER_UPPER_SYSTEM paper run directory without placing real orders.
"""
