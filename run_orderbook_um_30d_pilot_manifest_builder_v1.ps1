...
& $Python "src\edge_factory_orderbook_um_30d_pilot_manifest_builder_v1.py"
$ExitCode = $LASTEXITCODE

Write-Host "status: manifest_builder_exit_code=$ExitCode"
Write-Host "manifest: outputs\orderbook_um_30d_pilot_manifest.csv"
Write-Host "summary: outputs\orderbook_um_30d_pilot_manifest_summary.json"
