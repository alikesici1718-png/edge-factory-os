...
& $Python 'src\edge_factory_orderbook_um_aggtrades_pilot_downloader_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: aggtrades_pilot_download_exit_code=$ExitCode"
Write-Host "schema_summary: outputs\orderbook_um_aggtrades_pilot_schema_summary.json"
