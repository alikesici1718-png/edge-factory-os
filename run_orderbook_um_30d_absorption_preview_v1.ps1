...
& $Python "src\edge_factory_orderbook_um_30d_absorption_preview_v1.py"
$ExitCode = $LASTEXITCODE

Write-Host "status: absorption_preview_exit_code=$ExitCode"
Write-Host "summary: outputs\orderbook_um_30d_absorption_preview_summary.json"
Write-Host "category_diagnostics: outputs\orderbook_um_30d_absorption_category_diagnostics.csv"
Write-Host "daily_stability: outputs\orderbook_um_30d_absorption_daily_stability.csv"
Write-Host "symbol_stability: outputs\orderbook_um_30d_absorption_symbol_stability.csv"
