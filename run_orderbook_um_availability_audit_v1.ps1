...
& $Python 'src\edge_factory_orderbook_um_availability_audit_v1.py'
$ExitCode = $LASTEXITCODE

Write-Host "status: availability_audit_exit_code=$ExitCode"
Write-Host "manifest: outputs\orderbook_um_bookdepth_availability_manifest.csv"
